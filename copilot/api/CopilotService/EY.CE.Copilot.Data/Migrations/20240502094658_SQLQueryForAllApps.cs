...
{
    /// <inheritdoc />
    public partial class SQLQueryForAllApps : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 55,
                columns: new[] { "AnswerSQL", "SuggestionText" },
                values: new object[] { null, "How many systems are tagged to Day 1 processes?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 62,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { null, "CE4-TSA", "Show me the count of TSAs by function." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 63,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { null, "CE4-TSA", "Show me the count of TSAs by sub function." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 64,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { null, "CE4-TSA", "Show me the count of TSAs by region." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 65,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { null, "CE4-TSA", "How many of the TSAs are behind schedule?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 69,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { null, "CE4-PL", "How many systems are tagged to Current State processes?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 70,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { null, "CE4-PL", "How many systems are tagged to Day 1 processes?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 71,
                columns: new[] { "AppAffinity", "SuggestionText" },
                values: new object[] { "CE4-PL", "What team has the most Current State processes?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 72,
                columns: new[] { "AppAffinity", "SuggestionText" },
                values: new object[] { "CE4-PL", "What team has the most Day 1 processes?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 73,
                columns: new[] { "AppAffinity", "SuggestionText" },
                values: new object[] { "CE4-PL", "What are some of the processes that have High impact Risk/Issue linked?" });
