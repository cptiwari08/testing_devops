...
namespace EY.CE.Copilot.Data.Migrations
{
    ...
    [Migration("20250703084104_NewPromptsSeeding_Migration6")]
    partial class NewPromptsSeeding_Migration6
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EY.CE.Copilot.Data.Models.AssistantPrompt", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AssistantPrompts", (string)null);

                    b.HasData(
                        new
                        {
                            ID = 1,
                            Agent = "WORKPLAN_GENERATOR",
                            CreatedBy = "System",
                            IsActive = false,
                            Key = "DETECT_MISMATCH",
                        ...
                        new
                        {
                            ...
                            OriginalPrompt = "select DISTINCT PT.Title as ProjectTeam from ProjectTeams PT JOIN TeamTypes TT on TT.ID = PT.TeamTypeId where TT.[Key] = 'PROJECT_MANAGEMENT' AND PT.ManageWorkPlan = 1",
                            Prompt = "select DISTINCT PT.Title as ProjectTeam from ProjectTeams PT JOIN TeamTypes TT on TT.ID = PT.TeamTypeId where TT.[Key] = 'PROJECT_MANAGEMENT' AND PT.ManageWorkPlan = 1",
                            Title = "Interdependencies Query",
                            Type = "SYSTEM",
                            UpdatedBy = "System"
                        },
                        new
                        ...
                        new
                        {
                            ...
                            Prompt = "\"You are a Strategy and Transactions Senior Partner with 40 years of industry experience.Your expertise lies in creating detailed outlines for a project work plan.You will receive a list of elements which composed a generic project outline, each related to different topics: goals, objectives, project descriptions, success factors, and milestones.Additionally, you will be provided with some project context, which could be a guide about extra information related to the project.Your task is to enrich the generic workplan outlines by using the project context.Ensure the outlines are well-structured, logically organized, and cover all the key aspects necessary for effective project planning.You have been provided with the following elements:----------------------------------------------{{{project_outline_elements}project_context: {project_context}}}----------------------------------------------Ensure that:    -The details are clear, easy to understand, and accurately reflect the provided elements.    -Each piece of information captures the essence of the respective topic.    -The resulting information is logically structured and comprehensive.    -The JSON string must be free of any enclosing quotation marks and 'json' keyword.    -The project context will enrich the outline only if it adds significant value to the work plan.Provide your summaries in the following format:{{\"\"goal_summary\"\": \"\"{{Adapt the goal based on the provided project context}}\"\",\"\"objective_summary\"\": \"\"{{Adapt the objective based on the provided project context}}\"\",\"\"project_description_summary\"\": \"\"{{Adapt the project description based on the provided project context}}\"\",\"\"success_factors_summary\"\": \"\"{{Adapt the success factors based on the provided project context}}\"\",\"\"milestones_summary\"\": \"\"{{Adapt the milestones based on the provided project context}}\"\"}}Answer:\"",
                            Title = "Project Outline Enrichment No Docs",
                            Type = "SYSTEM",
                            UpdatedBy = "System"
                        },
                        new
                        {
                            ...
                            Prompt = "\"You are a Strategy and Transactions Senior Partner with 40 years of industry experience.Your expertise lies in creating detailed outlines for a project work plan.You will receive a list of elements, each containing chunks of information related to different topics: goals, objectives, project descriptions, success factors, and milestones.Additionally, you will be provided with some project context, which could be a guide about extra information related to the project.Your task is to synthesize this information into comprehensive outlines that will serve as the foundation for building a complete work plan.Ensure the outlines are well-structured, logically organized, and cover all the key aspects necessary for effective project planning.You have been provided with the following elements:----------------------------------------------{{goal_elements: {goal_elements}objective_elements: {objective_elements}project_description_elements: {project_description_elements}success_factors_elements: {success_factors_elements}milestones_elements: {milestone_elements}project_context: {project_context}}}----------------------------------------------Ensure that:    -The details are clear, easy to understand, and accurately reflect the provided elements.    -Each piece of information captures the essence of the respective topic.    -The resulting information is logically structured and comprehensive.    -The JSON string must be free of any enclosing quotation marks and 'json' keyword.    -The project context will enrich the outline only if it adds significant value to the work plan.Provide your summaries in the following format:{{\"\"goal_summary\"\": \"\"{{Summarize the goal based on the provided elements}}\"\",\"\"objective_summary\"\": \"\"{{Summarize the objective based on the provided elements}}\"\",\"\"project_description_summary\"\": \"\"{{Summarize the project description based on the provided elements}}\"\",\"\"success_factors_summary\"\": \"\"{{Summarize the success factors based on the provided elements}}\"\",\"\"milestones_summary\"\": \"\"{{Summarize the milestones based on the provided elements}}\"\"}}Example:input:{{goal_elements: [\"\"Increase market share by 10%\"\", \"\"Expand into new regions\"\", \"\"Enhance brand recognition\"\"]objective_elements: [\"\"Launch new product line\"\", \"\"Improve customer satisfaction\"\", \"\"Reduce operational costs\"\"]project_description_elements: [\"\"Develop a marketing strategy\"\", \"\"Conduct market research\"\", \"\"Implement new sales tactics\"\"]success_factors_elements: [\"\"Customer satisfaction\"\", \"\"Market research\"\", \"\"Sales tactics\"\"]milestones_elements: [\"\"Product launch\"\", \"\"Customer feedback analysis\"\", \"\"Cost reduction analysis\"\"]}}output:{{\"\"goal_summary\"\": \"\"The goal is to increase market share by 10% through expansion into new regions and enhancing brand recognition.\"\",\"\"objective_summary\"\": \"\"The objective is to launch a new product line, improve customer satisfaction, and reduce operational costs.\"\",\"\"project_description_summary\"\": \"\"The project involves developing a marketing strategy, conducting market research, and implementing new sales tactics.\"\",\"\"success_factors_summary\"\": \"\"The success factors include customer satisfaction, market research, and sales tactics.\"\",\"\"milestones_summary\"\": \"\"The milestones include product launch, customer feedback analysis, and cost reduction analysis.\"\"}}Answer:\"",
                            Title = "Project Outline Enrichment",
                            Type = "SYSTEM",
                            UpdatedBy = "System"
                        },
                        new
                        {
                            ...
                            CreatedBy = "System",
                            IsActive = false,
                            Key = "PROJECT_OUTLINE_KEYS",
                            OriginalPrompt = "\"- Goals aims purposes of the project- Objectives targets of the project- Description overview summary outline of the project- Key critical success factors- Milestones deliverables of the project\"",
                            Prompt = "\"- Goals aims purposes of the project- Objectives targets of the project- Description overview summary outline of the project- Key critical success factors- Milestones deliverables of the project\"",
                            Title = "Project Outline Keys",
                            Type = "SYSTEM",
                            UpdatedBy = "System"
                        },
                        new
                        {
                            ...
                            Prompt = "\"You are a Strategy and Transactions Senior Partner with 40 years of industry experience.Your expertise lies in working with functional leads to develop detailed, function-specific work plans for {transaction_type} projects.You are currently collaborating with the {target_team} lead to create a high-quality work plan that leverages:      1.	Firm-specific IPs (industry-proven templates).  2.	Intelligent insights derived from context and business logic.The work plan must address gaps, interdependencies, and risks while being logically structured and actionable.The following work plan outline has been provided to you:### Work Plan Outline:----------------  sector: {sector}subSector: {subSector}  timeline: {timeline}----------------### Firm IP Templates (relevant to {target_team} activities):----------------related_activities_examples: {eyip_adapted_data}----------------  ### Requirements:Generate a function-specific work plan for the {target_team} that adheres to the following principles:  1.	Relevance: All tasks must align with the {target_team}'s role in the project. Avoid mixing tasks from other functions.  2.	Clarity: Tasks must be precise, actionable, and follow a sequential and logical order.  3.	Completeness:      -Determine a sufficient number of tasks for each summary task to ensure a highly detailed and thorough plan.      -Address identified risks, assumptions, interdependencies, and decisions.      -Highlight interdependencies with other functions clearly:        - For each task that depends on another function, explicitly state the dependency within the task description.        - Create a task to address the interdependency, ensuring it is actionable and relevant to the current team's responsibilities.        - Include the interdependency in parentheses within the task description, e.g., 'Coordination for employee data and HRIS migration (Interdependency on HR).        - Ensure interdependent tasks are logically placed in the sequence and linked to relevant milestones.  4.	Structure: Group tasks under summary tasks, ensuring each summary task has a milestone.### Deliverable Format:-Provide the work plan in JSON format, structured as follows:----------------{example_structure}-----------------Do not add any comments or additional information to your response, just the JSON structure.### Instructions for Execution:  1.	Analyze Inputs: Examine all information to identify deliverables, milestones, and risks.      2.	Structure the Plan: Ensure tasks are grouped under relevant summary tasks with corresponding milestones.  3.	Account for Interdependencies: Clearly highlight any cross-functional dependencies in the task descriptions.  4.	Quality Assurance: Maintain a concise format while ensuring depth and completeness.      5.  Answer with the JSON structure, withoud any comments or additional information.Answer:\"",
                            Title = "Task Generation Without Project Outlines",
                            Type = "SYSTEM",
                            UpdatedBy = "System"
                        },
                        new
                        ...
                        {
                            ID = 13,
                            Agent = "STATUS_REPORT_GENERATOR",
                            CreatedBy = "System",
                            IsActive = false,
                            Key = "ACC_AND_NE_CHAR_LIMIT_QUERY",
                            OriginalPrompt = "SELECT CHARACTER_MAXIMUM_LENGTH AS MaxCharLimit FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'AccomplishmentsAndNextSteps' AND COLUMN_NAME = 'Title'",
                            Prompt = "SELECT CHARACTER_MAXIMUM_LENGTH AS MaxCharLimit FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'AccomplishmentsAndNextSteps' AND COLUMN_NAME = 'Title'",
                            Title = "Acc And Ne Char Limit Query",
                            Type = "SYSTEM",
                            UpdatedBy = "System"
                        },
                        new
                        ...
                        new
                        {
                            ...
                            CreatedBy = "System",
                            IsActive = false,
                            Key = "ASSISTANT_CONTENT_GENERATOR_QUERIES",
                            OriginalPrompt = "\"SELECT title, description as rules, key, sqlQueryFROM [AssistantContentGeneratorQueries]WHEREgeneratorType='ProjectStatus'ANDisActive is true\"",
                            Prompt = "\"SELECT title, description as rules, key, sqlQueryFROM [AssistantContentGeneratorQueries]WHEREgeneratorType='ProjectStatus'ANDisActive is true\"",
                            Title = "Assistant Content Generator Queries",
                            Type = "SYSTEM",
                            UpdatedBy = "System"
                        },
                        new
                        {
                            ...
                            OriginalPrompt = "\"SELECT CHARACTER_MAXIMUM_LENGTH AS MaxCharLimitFROM INFORMATION_SCHEMA.COLUMNSWHERETABLE_NAME = 'ProjectStatusEntries'AND COLUMN_NAME = 'ExecutiveSummary'\"",
                            Prompt = "\"SELECT CHARACTER_MAXIMUM_LENGTH AS MaxCharLimitFROM INFORMATION_SCHEMA.COLUMNSWHERETABLE_NAME = 'ProjectStatusEntries'AND COLUMN_NAME = 'ExecutiveSummary'\"",
                            Title = "Executive Summary Char Limit Query",
                            Type = "SYSTEM",
                            UpdatedBy = "System"
                        },
                        new
                        {
                            ...
                            OriginalPrompt = "\"SELECT TOP 3 PSE.ExecutiveSummary AS ExecutiveSummaryFROM ProjectStatusEntries PSELEFT JOIN ProjectTeams PT ON PSE.ProjectTeamID = PT.IDLEFT JOIN ReportingPeriods RP ON PSE.ReportingPeriodID = RP.IDWHEREPSE.ExecutiveSummary IS NOT NULL\"",
                            Prompt = "\"SELECT TOP 3 PSE.ExecutiveSummary AS ExecutiveSummaryFROM ProjectStatusEntries PSELEFT JOIN ProjectTeams PT ON PSE.ProjectTeamID = PT.IDLEFT JOIN ReportingPeriods RP ON PSE.ReportingPeriodID = RP.IDWHEREPSE.ExecutiveSummary IS NOT NULL\"",
                            Title = "Executive Summary Sql Examples",
                            Type = "SYSTEM",
                            UpdatedBy = "System"
                        },
                        new
                        ...
                        new
                        {
                            ...
                            IsActive = false,
                            Key = "STATUS_ID_QUERY",
                            OriginalPrompt = "SELECT Id FROM WeeklyStatusStatuses WHERE Title = '{{StatusTitle}}'",
                            Prompt = "SELECT Id FROM WeeklyStatusStatuses WHERE Title = '{{StatusTitle}}'",
                            Title = "Status Id Query",
                            Type = "SYSTEM",
                            UpdatedBy = "System"
                        },
                        new
                        ...
                        new
                        {
                            ...
                            OriginalPrompt = "\"[\r\n    {\r\n      \"\"title\"\": \"\"TSA service title\"\",\r\n      \"\"serviceInScopeDescription\"\": \"\"\r\n      - detailed description of the service point 1 \r\n      - detailed description of the service point 2\"\"\r\n    },\r\n    {\r\n      \"\"title\"\": \"\"TSA service title\"\",\r\n      \"\"serviceInScopeDescription\"\": \"\"\r\n      - detailed description of the service point 1 \r\n      - detailed description of the service point 2\"\"\r\n    },\r\n    {\r\n      \"\"title\"\": \"\"TSA service title\"\",\r\n      \"\"serviceInScopeDescription\"\": \"\"\r\n      - detailed description of the service point 1 \r\n      - detailed description of the service point 2\"\"\r\n    }\r\n  ]\"",
                            Prompt = "\"[\r\n    {\r\n      \"\"title\"\": \"\"TSA service title\"\",\r\n      \"\"serviceInScopeDescription\"\": \"\"\r\n      - detailed description of the service point 1 \r\n      - detailed description of the service point 2\"\"\r\n    },\r\n    {\r\n      \"\"title\"\": \"\"TSA service title\"\",\r\n      \"\"serviceInScopeDescription\"\": \"\"\r\n      - detailed description of the service point 1 \r\n      - detailed description of the service point 2\"\"\r\n    },\r\n    {\r\n      \"\"title\"\": \"\"TSA service title\"\",\r\n      \"\"serviceInScopeDescription\"\": \"\"\r\n      - detailed description of the service point 1 \r\n      - detailed description of the service point 2\"\"\r\n    }\r\n  ]\"",
                            Title = "Example TSA Structure",
                            Type = "SYSTEM",
                            UpdatedBy = "System"
                        },
                        new
                        {
                            ...
                            CreatedBy = "System",
                            IsActive = true,
                            Key = "PROJECT_DOCUMENT_KEYS",
                            OriginalPrompt = "\"['TSA', 'rTSA', 'Disposition', 'Processes']\"",
                            Prompt = "\"['TSA', 'rTSA', 'Disposition', 'Processes']\"",
                            Title = "Project Document Keys",
                            Type = "SYSTEM",
                            UpdatedBy = "System"
                        },
                        new
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            Key = "TSA_GENERATION",
                            OriginalPrompt = "\"You are a Strategy and Transactions Senior Partner with 40 years of industry experience.\r\n  Your expertise lies in  working with functional leads to develop detailed TSAs for {transaction_type} projects.\r\n  Your task is to create a comprehensive TSA based on the provided inputs for the {team} project team with flexible input combinations.\r\n\r\n  POSSIBLE INPUTS CAN BE:\r\n  1. Operating Model: \r\n      A conceptual framework that outlines how an organization delivers value to its customers and stakeholders. \r\n      It serves as a blueprint for how various components of the organization work together to achieve strategic objectives.\r\n      Generate one TSA based on each operating model.\r\n  2. Project Documentation: \r\n      Some operating models retrieved from documents uploaded by the user, these operating model might have a different format and titles but is the same meaning.\r\n      Generate one TSA based on each operating model retrieved from documents.\r\n  3. EY Intellectual Property (EYIP): Here we have templates or blueprint for a TSA of the same transaction type for the {team} project team. Generate one TSA based on each EYIP.\r\n  4. Application Inventory Tracker: \r\n      A comprehensive inventory of software applications within the organization.\r\n      Application names can be used as TSA title, please generate one TSA based on each item in Application Inventory Tracker.\r\n  5. Project Information: Details about the project teams including:\r\n     - Sector\r\n     - Subsector\r\n     - Transaction Type\r\n   6. Specific team related data: Documentation mentioning details about {team} project team.\r\n\r\n  FLEXIBLE INPUT HANDLING:\r\n  - Generate TSAs based on whatever inputs are available\r\n  - Generate additional TSAs to complement the TSAs generated based on input data, ensure there is at least {min_tsa} TSA generated.\r\n  - Ensure the response is complete and useful regardless of which inputs were provided\r\n\r\n  REQUIREMENTS:\r\n  1. Create a comprehensive list of TSA services for the {team} team\r\n  2. Each service should include:\r\n     - A clear title that describes the service\r\n     - A detailed description of the service scope in bullet points (markdown format)\r\n  3. Ensure all services are relevant to the {team}'s responsibilities\r\n  4. Descriptions should be clear, concise, and actionable\r\n\r\n  DELIVERABLE FORMAT:\r\n  Provide the TSA in JSON format, structured as follows:\r\n  ----\r\n  {example_structure}\r\n  ----\r\n\r\n  INSTRUCTIONS FOR EXECUTION:\r\n  - Output should be in the exact JSON structure specified. Without mentioning anything the format in the response.\r\n  - Do not include any explanations or additional information, just the structure.\r\n\r\n  INPUTS:\r\n  1. Project Documentation: {project_documentation}\r\n  2. Operating Model: {operating_model}\r\n  3. EY Intellectual Property: {eyip_adapted_data}\r\n  4. Application Inventory Tracker: {app_inventory}\r\n  5. Project Information:\r\n     - Sector: {sector}\r\n     - Subsector: {sub_sector}\r\n     - Transaction Type: {transaction_type}\r\n   6. Specific team related data: {search_results}\r\n\r\n  ANSWER:\"",
                            Prompt = "\"You are a Strategy and Transactions Senior Partner with 40 years of industry experience.\r\n  Your expertise lies in  working with functional leads to develop detailed TSAs for {transaction_type} projects.\r\n  Your task is to create a comprehensive TSA based on the provided inputs for the {team} project team with flexible input combinations.\r\n\r\n  POSSIBLE INPUTS CAN BE:\r\n  1. Operating Model: \r\n      A conceptual framework that outlines how an organization delivers value to its customers and stakeholders. \r\n      It serves as a blueprint for how various components of the organization work together to achieve strategic objectives.\r\n      Generate one TSA based on each operating model.\r\n  2. Project Documentation: \r\n      Some operating models retrieved from documents uploaded by the user, these operating model might have a different format and titles but is the same meaning.\r\n      Generate one TSA based on each operating model retrieved from documents.\r\n  3. EY Intellectual Property (EYIP): Here we have templates or blueprint for a TSA of the same transaction type for the {team} project team. Generate one TSA based on each EYIP.\r\n  4. Application Inventory Tracker: \r\n      A comprehensive inventory of software applications within the organization.\r\n      Application names can be used as TSA title, please generate one TSA based on each item in Application Inventory Tracker.\r\n  5. Project Information: Details about the project teams including:\r\n     - Sector\r\n     - Subsector\r\n     - Transaction Type\r\n   6. Specific team related data: Documentation mentioning details about {team} project team.\r\n\r\n  FLEXIBLE INPUT HANDLING:\r\n  - Generate TSAs based on whatever inputs are available\r\n  - Generate additional TSAs to complement the TSAs generated based on input data, ensure there is at least {min_tsa} TSA generated.\r\n  - Ensure the response is complete and useful regardless of which inputs were provided\r\n\r\n  REQUIREMENTS:\r\n  1. Create a comprehensive list of TSA services for the {team} team\r\n  2. Each service should include:\r\n     - A clear title that describes the service\r\n     - A detailed description of the service scope in bullet points (markdown format)\r\n  3. Ensure all services are relevant to the {team}'s responsibilities\r\n  4. Descriptions should be clear, concise, and actionable\r\n\r\n  DELIVERABLE FORMAT:\r\n  Provide the TSA in JSON format, structured as follows:\r\n  ----\r\n  {example_structure}\r\n  ----\r\n\r\n  INSTRUCTIONS FOR EXECUTION:\r\n  - Output should be in the exact JSON structure specified. Without mentioning anything the format in the response.\r\n  - Do not include any explanations or additional information, just the structure.\r\n\r\n  INPUTS:\r\n  1. Project Documentation: {project_documentation}\r\n  2. Operating Model: {operating_model}\r\n  3. EY Intellectual Property: {eyip_adapted_data}\r\n  4. Application Inventory Tracker: {app_inventory}\r\n  5. Project Information:\r\n     - Sector: {sector}\r\n     - Subsector: {sub_sector}\r\n     - Transaction Type: {transaction_type}\r\n   6. Specific team related data: {search_results}\r\n\r\n  ANSWER:\"",
                            Title = "TSA Generation",
                            Type = "SYSTEM",
                            UpdatedBy = "System"
                        },
                        new
                        {
                            ...
                            CreatedBy = "System",
                            IsActive = true,
                            Key = "SUMMARY_DOCUMENTS",
                            OriginalPrompt = "\"SUMMARY_DOCUMENTS','Summarize the content of the provided documents into a concise title that does not exceed 40 words, focusing on key insights, themes, and important details.\"",
                            Prompt = "\"SUMMARY_DOCUMENTS','Summarize the content of the provided documents into a concise title that does not exceed 40 words, focusing on key insights, themes, and important details.\"",
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            Key = "SUMMARY_AGENT",
                            OriginalPrompt = "\"Extract a concise description, focusing on the key insights and themes of this set of documents (not exceeding 500 characters).\"",
                            Prompt = "\"Extract a concise description, focusing on the key insights and themes of this set of documents (not exceeding 500 characters).\"",
                            Title = "Summary Agent",
                            Type = "SYSTEM",
                            UpdatedBy = "System"
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            Key = "TITLE_AGENT",
                            OriginalPrompt = "\"Summarize the content of the provided documents into a concise title that does not exceed 20 words (use maximum 55 characters). Use underscores to connect words, similar to this format: taxes_finance_uk. Every character MUST match this pattern: [a-z0-9_]{1,30}. Do not use any special characters or spaces.\"",
                            Prompt = "\"Summarize the content of the provided documents into a concise title that does not exceed 20 words (use maximum 55 characters). Use underscores to connect words, similar to this format: taxes_finance_uk. Every character MUST match this pattern: [a-z0-9_]{1,30}. Do not use any special characters or spaces.\"",
                            Title = "Title Agent",
                            Type = "SYSTEM",
                            UpdatedBy = "System"
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            Key = "SUMMARY_TOOL",
                            OriginalPrompt = "\"Useful for any requests that require a holistic summary of EVERYTHING about {\", \".join(documents[\"titles\"])} or similar topics. For questions about more specific sections, please use the vector_tool.\"",
                            Prompt = "\"Useful for any requests that require a holistic summary of EVERYTHING about {\", \".join(documents[\"titles\"])} or similar topics. For questions about more specific sections, please use the vector_tool.\"",
                            Title = "Summary Tool",
                            Type = "SYSTEM",
                            UpdatedBy = "System"
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            Key = "VECTOR_TOOL",
                            OriginalPrompt = "\"Use this tool for fact-based questions related to specific content in the user documentation.\r\nThis tool allows you to extract precise information, definitions, and answers to targeted queries.\r\nIt is designed for users who need detailed and accurate responses to specific questions, ensuring quick access to relevant facts and data.\r\nUtilize this tool when you require clarification on a feature, instructions, or troubleshooting steps,\r\nensuring that your answers are grounded in the documentation.\"",
                            Prompt = "\"Use this tool for fact-based questions related to specific content in the user documentation.\r\nThis tool allows you to extract precise information, definitions, and answers to targeted queries.\r\nIt is designed for users who need detailed and accurate responses to specific questions, ensuring quick access to relevant facts and data.\r\nUtilize this tool when you require clarification on a feature, instructions, or troubleshooting steps,\r\nensuring that your answers are grounded in the documentation.\"",
                            Title = "Vector Tool",
                            Type = "SYSTEM",
                            UpdatedBy = "System"
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            Key = "AGENT_PROMPT",
                            OriginalPrompt = "\"You are a Strategy and Transactions Senior Partner with 40 years of industry experience, specialized in answering queries about the following documents: {doc_names}. \r\nYou must ALWAYS use at least one of the tools provided (summary_tool or vector_tool) when answering a question.\r\nYour responses should be constructed solely based on the information retrieved from these tools, without relying on prior knowledge or experience.\r\nBe as detailed and verbose as possible in your responses, ensuring that all information is derived from the tools used.\"",
                            Prompt = "\"You are a Strategy and Transactions Senior Partner with 40 years of industry experience, specialized in answering queries about the following documents: {doc_names}. \r\nYou must ALWAYS use at least one of the tools provided (summary_tool or vector_tool) when answering a question.\r\nYour responses should be constructed solely based on the information retrieved from these tools, without relying on prior knowledge or experience.\r\nBe as detailed and verbose as possible in your responses, ensuring that all information is derived from the tools used.\"",
                            Title = "Agent Prompt",
                            Type = "SYSTEM",
                            UpdatedBy = "System"
                        });
            ...
            modelBuilder.Entity("EY.CE.Copilot.Data.Models.ContentGeneratorQuery", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AssistantContentGeneratorQueries", (string)null);
            ...
            modelBuilder.Entity("EY.CE.Copilot.Data.Models.GeneratorHistory", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AssistantGeneratorHistory");
                });

            modelBuilder.Entity("EY.CE.Copilot.Data.Models.Glossary", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AssistantGlossary", (string)null);
            ...
            modelBuilder.Entity("EY.CE.Copilot.Data.Models.Suggestion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 9,
                            AnswerSQL = "SELECT      COUNT(*) AS InterdependenciesDueThisWeek FROM      Interdependencies I  LEFT JOIN      statuses S ON I.InterdependencyStatusId = S.ID LEFT JOIn ProjectTeams PT on PT.ID = I.ReceiverProjectTeamId LEFT JOIN TeamTypes TT on TT.ID = PT.TeamTypeId WHERE   YEAR(I.ItemDueDate) = YEAR(GETDATE())      AND DATEPART(WEEK, I.ItemDueDate) = DATEPART(WEEK, GETDATE())      AND (S.[Key] IS NULL OR S.[Key] NOT IN ('COMPLETED', 'CLOSED', 'CANCELLED')) AND TT.[Key] = 'PROJECT_MANAGEMENT'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            IsIncluded = true,
                            Source = "project-data",
                        ...
                        new
                        {
                            ...
                            IsIncluded = true,
                            Source = "project-data",
                            SuggestionText = "Which teams have not entered their weekly status report for this reporting period?",
                            UpdatedBy = "System",
                            VisibleToAssistant = true
                        },
                        new
                        ...
                        new
                        {
                            ...
                            IsIncluded = false,
                            Source = "project-data",
                            SuggestionText = "What are the accomplishment and next steps of Finance team last week?",
                            UpdatedBy = "System",
                            VisibleToAssistant = false
                        },
                        new
                        {
                            ID = 82,
                            AnswerSQL = "select PSE.ExecutiveSummary from ProjectStatusEntries PSE JOIN ProjectTeams PT ON PSE.ProjectTeamID = PT.ID  JOIN ReportingPeriods RP ON PSE.ReportingPeriodID = RP.ID WHERE PT.Title = 'Finance' AND RP.ID = (SELECT RPID.ID -1 FROM ReportingPeriods RPID WHERE GETDATE() BETWEEN RPID.PeriodStartDate AND RPID.PeriodEndDate)",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            IsIncluded = false,
                            Source = "project-data",
                            SuggestionText = "What is the executive summary for Finance from the last reporting period?",
                            UpdatedBy = "System",
                            VisibleToAssistant = false
                        },
                        new
                        {
                            ...
                            IsIncluded = false,
                            Source = "project-data",
                            SuggestionText = "What is the executive summary for Finance from the current reporting period?",
                            UpdatedBy = "System",
                            VisibleToAssistant = false
                        },
                        new
                        {
                            ...
                            IsIncluded = false,
                            Source = "project-data",
                            SuggestionText = "What is the executive summary of Finance team this week?",
                            UpdatedBy = "System",
                            VisibleToAssistant = false
                        },
                        new
                        {
                            ID = 85,
                            AnswerSQL = "select COUNT(UP.ID) from UserProfiles UP LEFT JOIN AccountStatuses ACCS on ACCS.ID = UP.AccountStatusId where ACCS.[Key] = 'PROJECT_ENABLED'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            IsIncluded = false,
                            Source = "project-data",
                            SuggestionText = "How many users have access to the PMO app?",
                            UpdatedBy = "System",
                            VisibleToAssistant = false
                        },
                        new
                        {
                            ...
                            IsIncluded = false,
                            Source = "project-data",
                            SuggestionText = "How many users have access to this project?",
                            UpdatedBy = "System",
                            VisibleToAssistant = false
                        },
                        new
                        ...
                        new
                        {
                            ...
                            IsIncluded = false,
                            Source = "project-data",
                            SuggestionText = "Can I have a breakdown of IT tasks by status?",
                            UpdatedBy = "System",
                            VisibleToAssistant = false
                        },
                        new
                        ...
                        new
                        {
                            ...
                            IsIncluded = true,
                            Source = "project-data",
                            SuggestionText = "List all TSAs which are not getting settled in USD.",
                            UpdatedBy = "System",
                            VisibleToAssistant = true
                        },
                        new
                        ...
                        {
                            ID = 369,
                            AnswerSQL = "SELECT  A.UniqueItemIdentifier,  A.Title , PT.Title ProjectTeam, U.Title ItemOwner  FROM    Actions A      LEFT JOIN Statuses S ON A.ItemStatusId = S.ID      LEFT JOIN ProjectTeams PT ON A.ProjectTeamId = PT.ID   LEFT JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID    LEFT JOIN UserProfiles U ON A.ItemOwnerId = U.ID   WHERE    PT.Title = 'IT'  AND TT.[Key] = 'PROJECT_MANAGEMENT'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            IsIncluded = false,
                            Source = "project-data",
                            SuggestionText = "How many actions are assigned to IT team?",
                            UpdatedBy = "System",
                            VisibleToAssistant = false
                        },
                        new
                        {
                            ID = 370,
                            AnswerSQL = "SELECT       PT.Title AS ProjectTeam,                COUNT(A.UniqueItemIdentifier) AS ActionCount    FROM       Actions A      LEFT JOIN       ProjectTeams PT ON A.ProjectTeamId = PT.ID    LEFT JOIN       TeamTypes TT ON PT.TeamTypeId = TT.ID    WHERE       TT.[Key] = 'PROJECT_MANAGEMENT'   GROUP BY       PT.Title                           ORDER BY       ActionCount DESC",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            IsIncluded = true,
                            Source = "project-data",
                            SuggestionText = "Could you provide the number of action items categorized by project team?",
                            UpdatedBy = "System",
                            VisibleToAssistant = true
                        },
                        new
                        {
                            ID = 371,
                            AnswerSQL = "SELECT  A.UniqueItemIdentifier,  A.Title, PT.Title AS ProjectTeam, U.Title AS ItemOwner, S.Title as Status  FROM Actions A      LEFT JOIN Statuses S ON A.ItemStatusId = S.ID      LEFT JOIN ProjectTeams PT ON A.ProjectTeamId = PT.ID   LEFT JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID    LEFT JOIN UserProfiles U ON A.ItemOwnerId = U.ID   WHERE S.[KEY] NOT IN ('COMPLETED', 'CLOSED', 'CANCELLED', 'DELETED', 'REJECTED', 'ON_HOLD')   AND TT.[Key] = 'PROJECT_MANAGEMENT'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            IsIncluded = true,
                            Source = "project-data",
                            SuggestionText = "List all Open Actions in PMO app.",
                            UpdatedBy = "System",
                            VisibleToAssistant = true
                        },
                        new
                        {
                            ...
                            IsIncluded = true,
                            Source = "project-data",
                            SuggestionText = "Which team has the most current state processes?",
                            UpdatedBy = "System",
                            VisibleToAssistant = true
                        },
                        new
                        {
                            ...
                            IsIncluded = true,
                            Source = "project-data",
                            SuggestionText = "How much value have we already achieved from all of our initiatives?",
                            UpdatedBy = "System",
                            VisibleToAssistant = true
                        });
                });
