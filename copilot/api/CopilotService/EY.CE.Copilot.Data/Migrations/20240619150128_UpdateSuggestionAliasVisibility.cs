...
{
    /// <inheritdoc />
    public partial class UpdateSuggestionAliasVisibility : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 79,
                column: "AnswerSQL",
                value: "SELECT 'Total Top Down Target' AS KPI,  FORMAT((SUM(VTE.HeadcountCostReductionEst)+SUM(VTE.NonHeadcountCostReductionEst)+SUM(VTE.RevenueGrowthEstimate))/1000000,'N2') AS 'Value (Million)'  FROM ValueCaptureTopDownEstimates VTE");
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "SELECT SUM(VTE.NonHeadcountCostReductionEst) + SUM(VTE.RevenueGrowthEstimate) + SUM(VTE.HeadcountCostReductionEst) 'Total Top Down Target Value' FROM ValueCaptureTopDownEstimates VTE ", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 94,
                column: "AnswerSQL",
                value: "SELECT SUM(VTE.RevenueGrowthEstimate) RevenueGrowth,SUM(VTE.TotalCostReduction) CostReduction FROM ValueCaptureTopDownEstimates VTE");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 95,
                column: "AnswerSQL",
                value: "SELECT COUNT(1) FROM ValueCaptureInitiatives VI WHERE VI.IsItemActive = 1");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 109,
                column: "AnswerSQL",
                value: "SELECT PT.Title,SUM(ISNULL(VTE.NonHeadcountCostReductionEst,0)) + SUM(ISNULL(VTE.RevenueGrowthEstimate,0)) + SUM(ISNULL(VTE.HeadcountCostReductionEst,0)) AS TotalTopDownTarget  FROM ValueCaptureTopDownEstimates VTE LEFT JOIN ProjectTeams PT ON PT.ID = VTE.Projectteamid GROUP BY PT.Title");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 115,
                column: "AnswerSQL",
                value: "SELECT SUM(ISNULL(VTE.HeadcountCostReductionEst,0)) AS HeadcountCostReduction FROM ValueCaptureTopDownEstimates VTE");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 116,
                column: "AnswerSQL",
                value: "SELECT  SUM(ISNULL(VTE.NonHeadcountCostReductionEst,0)) AS NonHeadcountCostReduction FROM  ValueCaptureTopDownEstimates VTE");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 117,
                column: "AnswerSQL",
                value: "SELECT  SUM(ISNULL(VTE.RevenueGrowthEstimate,0)) AS RevenueGrowth FROM  ValueCaptureTopDownEstimates VTE");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 118,
                column: "AnswerSQL",
                value: "SELECT  SUM(ISNULL(VTE.CostToAchieveEstimate,0)) AS CostToAchive FROM  ValueCaptureTopDownEstimates VTE");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 126,
                column: "AnswerSQL",
                value: "SELECT     CONCAT('Tracking Period of the Program is from ', CAST(MIN(VTM.StartDt) AS DATE), ' to ', CAST(MAX(VTM.EndDt) AS DATE)) FROM     ValueCaptureTransactionMonths VTM WHERE     VTM.IsItemActive = 1");
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 156,
                columns: new[] { "AnswerSQL", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT SUM(T.FTEs) [FTEs part of the top down targets for EMEIA] FROM ValueCaptureTopDownEstimates T     LEFT JOIN Regions R         ON R.ID = T.RegionID WHERE R.Title = 'EMEIA'", "How many FTEs are part of the top down targets for EMEIA?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 267,
                columns: new[] { "AnswerSQL", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT     Title AS [TSAs that have duration for more than 18 months] FROM     TSAItems ts WHERE     Duration > 18", "List out TSAs that have duration for more than 18 months.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 276,
                columns: new[] { "AnswerSQL", "SuggestionText" },
                values: new object[] { "SELECT COUNT(TSA.ID) AS [TSA Items in Alignment phase for IT] FROM TSAItems TSA LEFT JOIN TSAPhases Stg         ON TSA.PhaseId = Stg.ID     LEFT JOIN Functions F         ON TSA.FunctionId = F.ID WHERE Stg.[Key] = 'ALIGNMENT'       AND F.Title = '{FunctionName}'", "How many items are in the allignment phase for IT?" });
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "SELECT DISTINCT WP._TemplateFile FROM WorkPlan WP", "CE4-PMO", "ey-guidance", "What PMO workplan templates are available?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 316,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT VCI.Title FROM ValueCaptureInitiatives VCI WHERE VCI.ValueCaptureType = 'Revenue Growth'", "CE4-VC", "What revenue growth levers are available?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 317,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT VCI.Title FROM ValueCaptureInitiatives VCI WHERE VCI.ValueCaptureType = 'one-time'", "CE4-VC", "What are typical one-time costs that we should be considering?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 318,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT VCI.Title FROM ValueCaptureInitiatives VCI WHERE VCI.ValueCaptureType = 'Cost Savings' AND VCI.ProjectTeam = 'IT'", "CE4-VC", "What are the IT cost savings levers that I should be thinking about?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 321,
                columns: new[] { "AnswerSQL", "SuggestionText" },
                values: new object[] { null, "Provide case studies/credentials for similar deals that EY have supported in the past." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 327,
                columns: new[] { "AnswerSQL", "SuggestionText" },
                values: new object[] { null, "Provide case studies/credentials for similar deals that EY has supported in the past." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 336,
                columns: new[] { "AnswerSQL", "SuggestionText" },
                values: new object[] { null, "Help me understand PMO methodology for this {ProjectType} project." });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 93,
                columns: new[] { "AnswerSQL", "VisibleToAssistant" },
                values: new object[] { "SELECT SUM(VCTDE.NonHeadcountCostReductionEst) + SUM(VCTDE.RevenueGrowthEstimate) + SUM(VCTDE.HeadcountCostReductionEst) 'Total Top Down Target Value' FROM ValueCaptureTopDownEstimates VCTDE", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 130,
                columns: new[] { "AnswerSQL", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT VCI.Title Initiatives FROM ValueCaptureInitiatives VCI WHERE VCI.ValueCapturePriorityId = 1", "List all initiatives that requires attention.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 140,
                columns: new[] { "AnswerSQL", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT SUM(VCTDE.NonHeadcountCostReductionEst) NonHeadcountCostReduction, SUM(VCTDE.HeadcountCostReductionEst) HeadcountCostReduction FROM ValueCaptureTopDownEstimates VCTDE", "What is the total of headcount and non-headcount related cost reduction?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 154,
                columns: new[] { "AnswerSQL", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT FL.Title [Balance sheet line items that do not have a linked account] FROM ValueCaptureFinancialLineItems FL     LEFT JOIN ValueCaptureFinancialLineItemTypes FLT         ON FLT.ID = FL.FinancialLineItemTypeID     LEFT JOIN BalanceSheetAccounts BLA         ON BLA.FinancialLineItemID = FL.ID WHERE FLT.Title = 'Balance Sheet'       AND BLA.ID IS NULL", "Show me all Balance sheet line items that do not have a linked account.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 157,
                columns: new[] { "AnswerSQL", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT SUM(T.FTEs) [FTEs part of the top down targets for EMEIA] FROM ValueCaptureTopDownEstimates T     LEFT JOIN Regions R         ON R.ID = T.RegionID WHERE R.Title = 'EMEIA'", "How many FTEs are part of the top down targets for EMEIA?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 158,
                columns: new[] { "AnswerSQL", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT VI.Title [Initiatives with Benefit score over 75] FROM ValueCaptureInitiatives VI LEFT JOIN ProjectTeams PT ON PT.ID = VI.ProjectTeamId WHERE CAST(VI.BenefitScore AS INT) > 75 AND PT.Title IN ('HR')", "Which HR iniatives have a benefit score over 75?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 209,
                columns: new[] { "AnswerSQL", "SuggestionText" },
                values: new object[] { ";WITH GetSelectedFunction AS (SELECT id,            Title,            NodeParentID,            HierId = 1     FROM Nodes nd    WHERE NodeParentID IS NULL           AND TransactionStateID = 8     UNION ALL     SELECT nds.id,            nds.Title,            nds.NodeParentID,            HierId = HierId + 1     FROM Nodes nds,          GetSelectedFunction     where nds.NodeParentID = GetSelectedFunction.id    ) SELECT N.Title [Function],        NTSS.Title AS [Field Status],        OPS.Title AS [Op Status] FROM NodeTrackers NT     LEFT JOIN NodeTrackerStatuses NTS         ON NTS.NodeTrackerID = NT.ID     JOIN     (SELECT * FROM GetSelectedFunction gsf WHERE HierId = 2 and Title = 'HR') N         ON N.ID = NT.NodeId     LEFT JOIN NodeTrackerStatusFields NTSS         ON NTSS.ID = NTS.NodeTrackerStatusFieldId     LEFT JOIN OpStatuses OPS         ON OPS.ID = NTS.NodeTrackerStatusStatusId", "In the Progress Tracker, what is the current status of HR?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 271,
                columns: new[] { "AnswerSQL", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT     TSA.Title AS [TSAs that are ready to be approved] FROM     TSAItems      TSA     LEFT JOIN         TSAPhases Stg             ON TSA.PhaseId = Stg.ID WHERE     Stg.[Key] IN ( 'ALIGNMENT','APPROVAL') ", "List out TSAs are that are ready to be approved.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 296,
                columns: new[] { "AnswerSQL", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "	  SELECT    t.Title AS [List all TSAs which are not getting settled in USD]    FROM     TSAItems        AS t     LEFT OUTER JOIN         TSAStatuses s             ON t.tsaitemtsastatusid = s.id     	LEFT OUTER JOIN 	    TSACurrencies TSACurr  		    ON t.TSAItemLocalCurrencyId=TSACurr.ID 	LEFT OUTER JOIN Currencies Curr 	        ON TSACurr.CurrencyID=Curr.ID WHERE         Curr.Title<>'USD ($)'  	  AND s.title <> 'Canceled'", "List all TSAs which are not getting settled n USD.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 303,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT TSA.Title AS [TSA items which have been in Detailing phase for more than 15 days] FROM TSAItems TSA     LEFT JOIN TSAPhases Stg         ON TSA.PhaseId = Stg.ID WHERE Stg.[Key] = 'DETAILING'       AND CAST(TSA.Modified AS DATE) < CAST(GETDATE() - 15 AS DATE)", "CE4-TSA", "List all items which have been in Detailing phase for more than 15 days." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 317,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { null, "CE4-PMO", "Provide case studies/credentials for similar deals that EY has supported in the past." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 323,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT VCI.Title FROM ValueCaptureInitiatives VCI WHERE VCI.ValueCaptureType = 'one-time' AND VCI.ProjectTeam = 'Supply Chain'", "CE4-VC", "What are the one-time costs I should be expecting to incur for Supply Chain related initiatives?" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 364, null, "PROJECT_LEVEL", null, "System", "internet", "What are the key risks for a {ProjectType} project?", null, "System", true },
                    { 365, null, "PROJECT_LEVEL", null, "System", "internet", "What are the key milestones for a {ProjectType} project?", null, "System", true },
                    { 366, null, "PROJECT_LEVEL", null, "System", "internet", "What are the best practices to run weekly status meetings?", null, "System", true },
                    { 367, null, "PROJECT_LEVEL", null, "System", "internet", "What are the best practices to build workplan, and track dependencies?", null, "System", true }
                });
        }
    }
}
