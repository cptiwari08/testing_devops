...
namespace EY.CE.Copilot.Data.Migrations
{
    ...
    [Migration("20240828160804_AddTableAssistantGlossary")]
    partial class AddTableAssistantGlossary
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EY.CE.Copilot.Data.Models.Glossary", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 2,
                            Context = "When asked for list of tasks, name of task, workplan items, and want you to list them, use the column WorkPlan.Title always if needed and WorkPlan.UniqueItemIdentifier when possible.",
                            CreatedBy = "System",
                            IsSchema = false,
                            TableName = "|WorkPlan|",
                            Tag = "static",
                        ...
                        {
                            ID = 10,
                            Context = "When asked about ALREADY achieved initiatives you MUST use ValueCaptureActuals and ValueCaptureInitiatives tables",
                            CreatedBy = "System",
                            IsSchema = false,
                            TableName = "|ValueCaptureInitiatives|",
                            Tag = "static",
                        ...
                        {
                            ID = 17,
                            Context = "When I ask something about me or other person use the table UserProfiles to filter my email with the column Email or the table ActiveDirectory with columns AuthorID or EditorID",
                            CreatedBy = "System",
                            IsSchema = false,
                            TableName = "AllTables",
                            Tag = "static",
                        ...
                        {
                            ID = 27,
                            Context = "When asked about 'IT' team or 'IT' project team, please filter using the column Title from ProjectTeams table",
                            CreatedBy = "System",
                            IsSchema = false,
                            TableName = "AllTables",
                            Tag = "static",
                        ...
                        {
                            ID = 28,
                            Context = "If you receive information about Team Type join with the ProjectTeams table, include the filter. The name of the team type is on TeamTypes table in the column Title. Show this column if possible.",
                            CreatedBy = "System",
                            IsSchema = false,
                            TableName = "AllTables",
                            Tag = "static",
