...
namespace EY.CE.Copilot.Data.Migrations
{
    ...
    [Migration("20240502094658_SQLQueryForAllApps")]
    partial class SQLQueryForAllApps
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EY.CE.Copilot.Data.Models.Suggestion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedBy = "System",
                            Source = "project-data",
                            SuggestionText = "Which project team has the most overdue interdependencies?",
                            UpdatedBy = "System"
                        },
                        new
                        {
                        ...
                        {
                            ID = 48,
                            AnswerSQL = "SELECT S.Title, COUNT(VI.ID) AS InitiativeCount FROM ValueCaptureStages S LEFT JOIN ValueCaptureInitiatives VI ON S.ID = VI.ValueCaptureStageId LEFT JOIN UserProfiles UP on UP.ID = VI.ItemOwnerId Where UP.EMail = ${Useremail} GROUP BY S.Title; ",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 49,
                            AnswerSQL = "SELECT RI.Title FROM RisksAndIssuesToValueCaptureInitiativesForValueCaptureInitiativeIDs RIV JOIN ValueCaptureInitiatives VI ON VI.ID = RIV.ValueCaptureInitiativeId JOIN RisksAndIssues RI ON RI.ID = RIV.RisksAndIssueId JOIN UserProfiles U ON U.ID = VI.ItemOwnerId WHERE U.Email = @UserEmail; ",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 53,
                            AnswerSQL = "select VI.Title from ValueCaptureInitiatives VI LEFT JOIN UserProfiles U on U.ID = VI.ItemOwnerId where U.EMail = ${Useremail} ",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 54,
                            AnswerSQL = "SELECT VI.Title  FROM ValueCaptureInitiatives VI LEFT JOIN ValueCaptureTypes VT ON VT.ID = VI.ValueCaptureTypeId LEFT JOIN UserProfiles U ON U.ID = VI.ItemOwnerId WHERE VT.ID = 1 AND U.EMail = ${Useremail}; ",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
