...
{
    /// <inheritdoc />
    public partial class NewSuggestionProjectData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 82,
                columns: new[] { "AnswerSQL", "AppAffinity", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "select PSE.ExecutiveSummary from ProjectStatusEntries PSE JOIN ProjectTeams PT ON PSE.ProjectTeamID = PT.ID  JOIN ReportingPeriods RP ON PSE.ReportingPeriodID = RP.ID WHERE PT.Title = 'Finance' AND RP.ID = (SELECT RPID.ID -1 FROM ReportingPeriods RPID WHERE GETDATE() BETWEEN RPID.PeriodStartDate AND RPID.PeriodEndDate)", "CE4-PMO", false, "What is the executive summary for Finance from the last reporting period?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 83,
                columns: new[] { "AnswerSQL", "AppAffinity", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "select PSE.ExecutiveSummary from ProjectStatusEntries PSE JOIN ProjectTeams PT ON PSE.ProjectTeamID = PT.ID  JOIN ReportingPeriods RP ON PSE.ReportingPeriodID = RP.ID WHERE PT.Title = 'Finance' AND RP.ID = (SELECT RPID.ID  FROM ReportingPeriods RPID WHERE GETDATE() BETWEEN RPID.PeriodStartDate AND RPID.PeriodEndDate)", "CE4-PMO", false, "What is the executive summary for Finance from the current reporting period?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 84,
                columns: new[] { "AnswerSQL", "AppAffinity", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "select PSE.ExecutiveSummary from ProjectStatusEntries PSE JOIN ProjectTeams PT ON PSE.ProjectTeamID = PT.ID  JOIN ReportingPeriods RP ON PSE.ReportingPeriodID = RP.ID WHERE PT.Title = 'Finance' AND RP.ID = (SELECT RPID.ID  FROM ReportingPeriods RPID WHERE GETDATE() BETWEEN RPID.PeriodStartDate AND RPID.PeriodEndDate)", "CE4-PMO", false, "What is the executive summary of Finance team this week?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 85,
                columns: new[] { "AnswerSQL", "AppAffinity", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "select COUNT(UP.ID) from UserProfiles UP LEFT JOIN AccountStatuses ACCS on ACCS.ID = UP.AccountStatusId where ACCS.[Key] = 'PROJECT_ENABLED'", "CE4-PMO", false, "How many users have access to the PMO app?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "select COUNT(UP.ID) from UserProfiles UP LEFT JOIN AccountStatuses ACCS on ACCS.ID = UP.AccountStatusId where ACCS.[Key] = 'PROJECT_ENABLED'", "CE4-PMO", "How many users have access to this project?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 97,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT VI.Title [Approved Initiaves] FROM ValueCaptureInitiatives VI LEFT JOIN ProjectTeams PT ON PT.ID = VI.ProjectTeamId LEFT JOIN ValueCaptureStages S ON S.ID = VI.ValueCaptureStageId WHERE PT.Title = {ProjectTeam} AND S.Title = 'Approved'", false, "List IT initiatives that are in approved stage.", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 102,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT COUNT(VCI.ID) AS InitativesCount FROM ValueCaptureInitiatives VCI LEFT JOIN ValueCaptureStages  VCS ON VCI.ValueCaptureStageId = VCS.ID WHERE VCS.Title = {ValueCaptureStage} ", false, "How many initiatives have been realized?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 103,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT SUM(VTE.NonHeadcountCostReductionEst) + SUM(VTE.RevenueGrowthEstimate) + SUM(VTE.HeadcountCostReductionEst) 'Total Top Down Target Value' FROM ValueCaptureTopDownEstimates VTE ", false, "What is the Total Top Down Target Value?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 104,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT SUM(VTE.RevenueGrowthEstimate) RevenueGrowth,SUM(VTE.TotalCostReduction) CostReduction FROM ValueCaptureTopDownEstimates VTE", true, "Show my top down target values by cost reduction and revenue growth.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 105,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT COUNT(1) FROM ValueCaptureInitiatives VI WHERE VI.IsItemActive = 1", true, "How many active initatives are there in my project?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 106,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT PT.Title [Project Team] ,CAST(SUM(ISNULL(VT.RevenueGrowthEstimate,0))/1000000 AS FLOAT) [Revenue Growth(in Million)] FROM ValueCaptureTopDownEstimates VT LEFT JOIN ProjectTeams PT ON PT.ID = VT.ProjectTeamId GROUP BY PT.Title", true, "What is the total of revenue growth by team?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 107,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT VC.Title AS [ValueCaptureInitiatives with no Owners] FROM ValueCaptureInitiatives VC WHERE VC.ItemOwnerId IS NULL", true, "List out initiatives with no owners assigned.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 111,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT VI.Title [Initiaves] FROM ValueCaptureInitiatives VI JOIN UserProfiles UP ON VI.ItemOwnerId = UP.ID WHERE UP.Title = '{Username}'", true, "List initiatives where I'm assigned as the Owner.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 114,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT COUNT(VCI.ID) as ValidatedInitiatives FROM ValueCaptureInitiatives VCI LEFT JOIN ValueCaptureStages VCS ON VCS.ID = VCI.ValueCaptureStageId WHERE VCS.Title = 'Validated' ", false, "How many initiatives have been validated?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 115,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT VCS.Title AS [Value Capture Stage] ,COUNT(VCI.ID) AS InitativesCount FROM ValueCaptureInitiatives VCI LEFT JOIN ValueCaptureStages VCS ON VCI.ValueCaptureStageId = VCS.ID GROUP BY VCS.Title", false, "Can you provide breakdown of the initiatives across various stages?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 120,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT VCS.Title AS ValueCaptureStage, COUNT(VC.ID) AS ValueCaptureStageCount FROM ValueCaptureInitiatives VC LEFT JOIN ValueCaptureStages VCS ON VCS.ID = VC.ValueCaptureStageId GROUP BY VC.ValueCaptureStageId, VCS.Title", false, "Show me initiatives count by stage.", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 125,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT SUM(ISNULL(VTE.HeadcountCostReductionEst,0)) AS HeadcountCostReduction FROM ValueCaptureTopDownEstimates VTE", true, "What is the Total Headcount Cost Reduction Target?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 127,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT  SUM(ISNULL(VTE.RevenueGrowthEstimate,0)) AS RevenueGrowth FROM  ValueCaptureTopDownEstimates VTE", true, "What is the Total Revenue Growth Target?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 138,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "	SELECT   	    COUNT(VCI.ID) AS [Initiative Count for Selected Evaluator Quad]  		     FROM ValueCaptureInitiatives VCI 		LEFT JOIN VCInitiativeEvaluatorQuadInfo VCQ  		    ON VCI.VCInitiativeEvaluatorQuadInfoId=VCQ.ID 		       WHERE VCQ.Title= {EvaluatorQuad}", false, "Based on Evaluator comparison, how many initiatives have 'High Benefit, High Complexity'?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 139,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT  ISNULL(SUM(Act.Amount), 0.0) - ISNULL(SUM(Est.Amount), 0.0) AS Variance FROM (     SELECT SUM(Est.Amount) AS Amount     FROM vwUnpivotEstimates Est         LEFT JOIN ValueCaptureInitiatives VCI             ON Est.ValueCaptureInitiativeId = VCI.ID         LEFT JOIN ProjectTeams PT             ON VCI.ProjectTeamId = PT.ID     WHERE PT.Title = '{ProjectTeam}' ) Est     JOIN     (         SELECT SUM(Act.Amount) AS Amount         FROM vwUnpivotActuals Act             LEFT JOIN ValueCaptureInitiatives VCI                 ON Act.ValueCaptureInitiativeId = VCI.ID             LEFT JOIN ProjectTeams PT                 ON VCI.ProjectTeamId = PT.ID         WHERE PT.Title = '{ProjectTeam}'     ) Act         ON 1 = 1", false, "What is my variance for the IT initiatives?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 144,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT  	ISNULL(SUM(UE.Amount)/1000000,0) AS GrossProfit FROM      ValueCaptureEstimates VE LEFT JOIN      ValueCaptureFinancialLineItems FL ON FL.ID = VE.FinancialLineItemId LEFT JOIN      ValueCaptureInitiatives VI ON VI.id = VE.ValueCaptureInitiativeId LEFT JOIN  	vwUnpivotEstimates UE ON UE.ID = VE.ID LEFT JOIN 	ValueCaptureFinancialLineItemTypes FLT ON FLT.ID = FL.FinancialLineItemTypeId LEFT JOIN 	ValueCaptureFinancialLineItemGroups FLG ON FLG.ID = FL.FinancialLineItemGroupId WHERE      FLT.Title = 'PnL'  AND FLG.Title in ('Gross Profit') ", true, "In the PnL, what is my gross profit?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 149,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT  SUM(VTE.NonHeadcountCostReductionEst) NonHeadcountCostReduction, SUM(VTE.HeadcountCostReductionEst) HeadcountCostReduction FROM ValueCaptureTopDownEstimates VTE", false, "What is the total of headcount and non-headcount related cost reduction?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 153,
                columns: new[] { "AnswerSQL", "SuggestionText" },
                values: new object[] { "SELECT  VC.Title AS ValueCaptureInitiativesReadyForApproval FROM  ValueCaptureInitiatives VC WHERE  VC.ReadyForApproval = 1", "List out validated initiatives that are ready to be approved." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 156,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "	SELECT TOP 5  		VI.Title [top 5 initiatives with best benefit score] 	FROM  		ValueCaptureInitiatives VI 	LEFT JOIN  		ValueCaptureImpacts VIM ON VIM.ID = VI.ValueCaptureImpactid 	WHERE  		VIM.ID in (1) 	ORDER BY  		VI.BenefitScore DESC", true, "List out top 5 initiatives with best benefit score that have high financial impact.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 160,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT VS.Title [Value Capture Stage],        VI.Title [Initiatives that have Talent intiative value drivers] FROM ValueCaptureInitiatives VI     LEFT JOIN ValueCaptureStages VS         ON VS.ID = VI.ValueCaptureStageID     LEFT JOIN ValueCaptureInitiativesToValueCaptureValueDriversForValueCaptureValueDrivers VD         ON VD.ValueCaptureInitiativeId = VI.ID     LEFT JOIN ValueCaptureValueDrivers VV         ON VD.ValueCaptureValueDriverId = VV.ID WHERE VV.Title = 'Talent' ", true, "Provide me a list of Iniatives by stage that have Talent iniative value drivers.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 166,
                columns: new[] { "AnswerSQL", "AppAffinity", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT SUM(T.FTEs) [FTEs part of the top down targets for EMEIA] FROM ValueCaptureTopDownEstimates T     LEFT JOIN Regions R         ON R.ID = T.RegionID WHERE R.Title = 'EMEIA'", "CE4-VC", false, "How many FTEs are part of the top down targets for EMEIA?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 167,
                columns: new[] { "AnswerSQL", "AppAffinity", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT VI.Title [Initiatives with Benefit score over 75] FROM ValueCaptureInitiatives VI LEFT JOIN ProjectTeams PT ON PT.ID = VI.ProjectTeamId WHERE CAST(VI.BenefitScore AS INT) > 75 AND PT.Title IN ('HR')", "CE4-VC", false, "Which HR iniatives have a benefit score over 75?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 169,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "select Top 5 VC.Title, VS.Title, VC.BenefitScore From ValueCaptureInitiatives VC LEFT JOIN ValueCaptureStages VS on VS.ID = VC.ValueCaptureStageId where VS.Title in ('Identified') order by BenefitScore desc", "CE4-VC", "List all High Benefit iniatives that are in the Identified Stage." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 196,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT [Object],        Details,        FieldImpacted,        OldValue AS [Old Value],        NewValue AS [New Value],        [Title] AS [Activity] FROM OperatingModelActivityLog opma WHERE Modified >= DATEADD(hh, -1, GETDATE())", true, "List history of changes to the op model in the past one hour.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 197,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT [Object],        Details,        FieldImpacted,        OldValue AS [Old Value],        NewValue AS [New Value],        [Title] AS [Activity] FROM OperatingModelActivityLog opma WHERE FieldImpacted = 'Owner'       AND CAST(Modified AS DATE) = CAST(GETDATE() AS DATE)", true, "List the history of changes to Ownership in the op model today.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 205,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { " SELECT PR.Title [Process] FROM Nodes PR     JOIN TransactionStates  S  ON S.ID = PR.TransactionStateId    LEFT JOIN  NodesToDispositionsForDispositionNew D             ON D.NodeId = PR.ID WHERE     PR.NodeTypeId = 3     AND D.NodeId IS NULL     AND S.[Key] = 'DAY_ONE'", false, "For Day 1 Operating Models, list all processes that doesn't have any dispositions.", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 207,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT     N.Title AS [List of Processes with Disposition as TSA] FROM   Nodes   N   LEFT JOIN     NodesToDispositionsForDispositionNew NTD             ON NTD.NodeId = N.ID     LEFT JOIN         Dispositions  D ON NTD.DispositionId = D.ID WHERE     D.Title = 'TSA'     AND N.NodeTypeId = 3", true, "List down all Processes which have their disposition set as TSA.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 209,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT COUNT(1)  [No. of Processes] FROM Nodes PR JOIN NODES P ON PR.NodeParentID = P.ID WHERE PR.NodeTypeId = 3 AND P.Title = '{FunctionName}'", false, "How many processes are there in the IT function?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 213,
                columns: new[] { "AnswerSQL", "SuggestionText" },
                values: new object[] { "SELECT     O.Title     AS [Process Owner],     COUNT(N.ID) AS [Process Distribution] FROM     Nodes      N     LEFT JOIN         Owners O             ON N.OwnerId = O.ID WHERE     N.NodeTypeId = 3 GROUP BY     O.Title ", "Provide process owner distribution for my project." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 216,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT A.Title Assest,        P.Title LinkedProcess FROM Assets A     LEFT JOIN ProcessAssetLinks PA         ON PA.AssetId = A.ID     LEFT JOIN Nodes P         ON P.ID = PA.ProcessId     LEFT JOIN NodeTypes NType         ON P.NodeTypeId = NType.ID WHERE NType.Title = 'Process'", true, "List the Assets and their linked processes.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 220,
                columns: new[] { "AnswerSQL", "SuggestionText" },
                values: new object[] { "SELECT     N.Title AS [List of Process which doesn''t have ownership] FROM     Nodes                 N     JOIN         TransactionStates T             ON T.ID = N.TransactionStateId WHERE     OwnerId IS NULL     AND N.NodeTypeId = 3", "List down all processes with no Owners assigned." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 223,
                columns: new[] { "AnswerSQL", "SuggestionText" },
                values: new object[] { "SELECT     N.Title AS [List of all Processes associated with APAC] FROM     Nodes       N     LEFT JOIN         Regions R             ON N.CountryRegionID = R.ID WHERE     n.NodeTypeId = 3     AND R.Title = '{Region}'", "Can you please list all processes associated with APAC?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 225,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT     [List of Processes with same name] FROM     (         SELECT             N.Title  AS [List of Processes with same name],             Count(1) AS [Repeat Count]         FROM             Nodes N         WHERE             N.NodeTypeId = 3         GROUP BY             N.Title         HAVING             COUNT(*) > 1     ) a ORDER BY     1 ", true, "Can you please list all processes with same name?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 241,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT N.Title [Processes with total headcount greater than 0] FROM Nodes N     LEFT JOIN vwHeadcount H         ON H.NodeId = N.ID     LEFT JOIN Nodetypes NT         ON NT.ID = N.NodeTypeId GROUP BY N.Title HAVING SUM(ISNULL(H.TotalHeadCount, 0)) > 0", true, "List all processes with total headcount greater than 0.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 243,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT COUNT(N.ID) [No of Proccesses to which TPA is assigned] FROM NodesToThirdPartyAgreementsForEnablerTpa NTP  INNER JOIN Nodes N ON N.ID = NTP.NodesId  LEFT JOIN NodeTypes NT ON N.NodeTypeId = NT.ID WHERE NT.Title = 'Process'", "CE4-OM", "How many processes have a TPA assigned to them? " });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 245,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT N.Title AS [List of Processes with Disposition set as TSA ] FROM Nodes N     LEFT JOIN NodeTypes NT         ON N.NodeTypeId = NT.ID     LEFT JOIN NodesToDispositionsForDispositionNew NTD         ON N.ID = NTD.NodeId     LEFT JOIN Dispositions D         on NTD.DispositionId = D.ID WHERE NT.Title = 'Process'       AND D.Title = 'TSA'", "CE4-OM", "List all processes that have the disposition TSA." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 246,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT COUNT(N.ID) AS [No of Processes are Live Without]  FROM Nodes N  LEFT JOIN NodeTypes NT ON N.NodeTypeId = NT.ID WHERE NT.Title = 'Process' AND N.ID IN (	SELECT NodeId 				FROM NodesToDispositionsForDispositionNew ND  				LEFT JOIN Dispositions D ON D.ID = DispositionID  				WHERE D.Title = 'Live without'			 				) ", "CE4-OM", "How many processes are Live without? " });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 247,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT     Title AS [Systems being used by Project Team and Process Group] FROM     Systems s WHERE  ID IN (                   SELECT DISTINCT                       SystemsId                   FROM                       Nodes N                       LEFT JOIN NodesToSystemsForEnablerSystems NSS                        ON N.ID = NSS.NodesId  					  LEFT JOIN  NodesToProjectTeamsForProjectTeam NP 					  ON N.ID = NP.NodesId  					  LEFT JOIN NodeTypes NT ON NT.ID = N.NodeTypeId                    WHERE  NT.Title IN ('ProcessGroup')               )	", "CE4-OM", "List out the systems being used by Project Team and Process Group." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 251,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT SF.Title, Count(1) as 'Number Of TSAs' from TSAItems T LEFT JOIN SubFunctions SF on SF.ID = T.SubFunctionId where T.SubFunctionId IS NOT NULL Group By SF.ID, SF.Title ", true, "Show me the count of TSAs by sub function.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 253,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT LE.Title, Count(1) as 'Number Of TSAs' from TSAItems T LEFT JOIN LegalEntities LE on LE.ID = T.ReceiverLegalEntityId Group By LE.ID, LE.Title ", true, "Give me the list of TSAs by Receiver.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 254,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT P.Title, T.Title from TSAItems T LEFT JOIN TSAPhases P on P.ID = T.PhaseId Group By P.ID, P.Title ", true, "Can you provide me list of TSAs by phases?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 255,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT T.Title, T.Duration as 'Duration in Month' from TSAItems T where T.Duration is not null ", true, "Show me the breakdown of TSAs by duration.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 256,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT PT.Title, Count(1) as 'Number Of TSAs' from TSAItems T LEFT JOIN ProjectTeams PT on PT.ID = T.ProjectTeamId Group by PT.ID, PT.Title ", true, "How many TSAs does each team have?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 257,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT    TST.Title as [Phase],    COUNT(TC.ID) AS [# TSAs across different phases] FROM    TSAItems TC    LEFT JOIN TSAPhases TST ON TC.PhaseID = TST.ID  Group BY    TST.Title ", true, "List the number of TSAs across different phases.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 259,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT    Title as [Billing Period Name],    DeadlineDate as [Contribution Deadlines]  FROM    TSABillingPeriods tb", false, "In Cost Tracking, how is my billing periods setup?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 261,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT    L.ServiceLocation  FROM    TSAItems T    JOIN LegalEntities L ON T.ProviderLegalEntityId = L.ID where  L.ServiceLocation is not null UNION  SELECT    L.ServiceLocation  FROM    TSAItems T    JOIN LegalEntities L ON T.ReceiverLegalEntityId = L.ID   where  L.ServiceLocation is not null ", false, "List the TSA service locations in my project.", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 262,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT     TSA.Title AS [TSAs],     s.Title   AS [TSA Statuses] FROM     TSAItems        TSA     LEFT JOIN         TSAStatuses S             ON TSA.TSAItemTSAStatusId = S.ID     LEFT JOIN         Functions   F             ON TSA.FunctionId = F.ID WHERE     F.Title = '{FunctionName}'", false, "List the TSAs for the Finance fucntion with their status.", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 266,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT    DISTINCT F.Title as [Functions To Be Configured] FROM    TSAReviewers TR    LEFT JOIN Functions F on F.ID = TR.FunctionId ", true, "In Reviewer Assignments, what functions require to be configured properly?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 272,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT     TSA.Title AS [TSAs] FROM     TSAItems        TSA     LEFT JOIN         TSAStatuses S             ON TSA.TSAItemTSAStatusId = S.ID WHERE          S.Title<>'{TSAStatus}'", false, "How many TSAs left to sign?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 273,
                columns: new[] { "AnswerSQL", "SuggestionText" },
                values: new object[] { "SELECT     COUNT(TSA.ID) AS [# TSAs signed by Function],     F.Title       AS Functions FROM     TSAItems        TSA     LEFT JOIN         TSAStatuses S             ON TSA.TSAItemTSAStatusId = S.ID     LEFT JOIN         Functions   F             ON TSA.FunctionId = F.ID WHERE     S.Title = '{TSAStatus}' GROUP BY     F.Title", "List number of signed TSAs by function." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 275,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT     Title AS [TSA Stages] FROM     TSAPhases t ORDER BY     Ordinal", true, "List out stages that are preconfigured on this instance for TSA lifecycle.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 278,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT     TSA.Title AS [TSAs that are ready to be approved] FROM     TSAItems      TSA     LEFT JOIN         TSAPhases Stg             ON TSA.PhaseId = Stg.ID WHERE     Stg.[Key] IN ( 'ALIGNMENT','APPROVAL') ", true, "List out TSAs are that are ready to be approved.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 281,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT UP.Title AS [Buyer Side Reviewer for Finance TSAs] FROM TSAReviewers TRev     LEFT JOIN Functions F         ON TRev.FunctionId = F.ID     LEFT JOIN UserProfiles UP         ON TRev.RecipientApproverID = UP.ID WHERE F.Title ='{FunctionName}'", false, "Who is the buy side reviewer for finance TSAs?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 282,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT UP.Title AS [Buyer Side Reviewer for Finance TSAs] FROM TSAReviewers TRev     LEFT JOIN Functions F         ON TRev.FunctionId = F.ID     LEFT JOIN UserProfiles UP         ON TRev.ProviderApproverId = UP.ID WHERE F.Title ='{FunctionName}'", false, "Who is the sell side reviewer for finance TSAs?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 283,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT UP.Title AS [Approver for Finance TSAs] FROM TSAReviewers TRev     LEFT JOIN Functions F         ON TRev.FunctionId = F.ID     LEFT JOIN UserProfiles UP         ON TRev.RecipientApproverID = UP.ID WHERE F.Title = '{FunctionName}'  UNION   SELECT UP.Title AS [Approver for Finance TSAs] FROM TSAReviewers TRev     LEFT JOIN Functions F         ON TRev.FunctionId = F.ID     LEFT JOIN UserProfiles UP         ON TRev.ProviderApproverId = UP.ID WHERE F.Title ='{FunctionName}'", false, "Who is the approver for finance TSAs?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 284,
                columns: new[] { "AnswerSQL", "SuggestionText" },
                values: new object[] { "SELECT TSA.Title AS [TSAs with Behind Schedule Tasks Linked] FROM TSAItems TSA     LEFT JOIN Workplan WP         ON TSA.ID = WP.TSAItemId     LEFT JOIN Statuses S         ON WP.ProgressId = S.ID WHERE WP.WorkPlanTaskType = 'Task'       AND S.[Key] = 'BEHIND_SCHEDULE'", "List out TSAs with behind schedule tasks linked." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 286,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT COUNT(TSA.ID) AS [TSA Items in Alignment phase for IT] FROM TSAItems TSA LEFT JOIN TSAPhases Stg         ON TSA.PhaseId = Stg.ID     LEFT JOIN Functions F         ON TSA.FunctionId = F.ID WHERE Stg.[Key] = 'ALIGNMENT'       AND F.Title = '{FunctionName}'", false, "How many items are in the allignment phase for IT?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 298,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT t.Title AS [TSAs due in next 45days] FROM TSAItems AS t     LEFT OUTER JOIN TSAStatuses s         ON t.tsaitemtsastatusid = s.id WHERE CAST(t.TSAItemEndDate AS DATE)       BETWEEN CAST(GETDATE() AS DATE) AND CAST(GETDATE() + 45 AS DATE)       AND s.title <> 'Canceled'", true, "List All TSAs due in next 45days.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 305,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT     ISNULL(Stg.Title, 'No Phase Assigned') AS [Phase],     (TSA.Title)                          AS [ TSAs title] FROM     TSAItems      TSA     LEFT JOIN         TSAPhases Stg             ON TSA.PhaseId = Stg.ID", "CE4-TSA", "List all TSAs per phase." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 311,
                columns: new[] { "AnswerSQL", "AppAffinity", "Source", "SuggestionText" },
                values: new object[] { "SELECT TSA.Title AS [Finance related TSA items with relevant SLA details],        ISNULL(TSA.TSAItemSLAName, ' ') AS [SLA Details] FROM TSAItems TSA     LEFT JOIN Functions F         ON TSA.FunctionId = F.ID     LEFT JOIN TSAStatuses S         ON TSA.TSAItemTSAStatusId = S.ID WHERE S.[Key] <> 'CANCELED'       AND F.Title = 'Finance'", "CE4-TSA", "project-data", "List all finance related items with relevant SLA details." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 313,
                columns: new[] { "AnswerSQL", "AppAffinity", "Source", "SuggestionText" },
                values: new object[] { "SELECT PT.Title as Team, TT.Title as 'Type'  from ProjectTeams PT LEFT JOIN TeamTypes TT on TT.ID = PT.TeamTypeId where TT.[Key] = 'PROJECT_MANAGEMENT' order by TT.Title", "PROJECT_LEVEL", "project-data", "What are the project teams that make up the governance structure for this engagement?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 317,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT DISTINCT _TemplateFile FROM WorkPlan", "CE4-PMO", "What PMO workplan templates are available?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 325,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT Title FROM ValueCaptureInitiatives WHERE ValueCaptureType = 'One Time Cost'", "CE4-VC", "What are typical one-time costs that we should be considering?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 326,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT Title FROM ValueCaptureInitiatives WHERE (ValueCaptureType = 'Cost Reduction' OR  ValueCaptureType = 'Cost Saving') AND ProjectTeam = 'IT'", "CE4-VC", "What are the IT cost savings levers that I should be thinking about?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 327,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT Title FROM ValueCaptureInitiatives WHERE ValueCaptureType = 'One Time Cost' AND ProjectTeam = 'Supply Chain & Operations'", "CE4-VC", "What are the one-time costs I should be expecting to incur for Supply Chain related initiatives?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 334,
                columns: new[] { "AnswerSQL", "AppAffinity", "Source", "SuggestionText" },
                values: new object[] { "SELECT Title FROM TSAItems", "CE4-TSA", "ey-guidance", "What TSAs would you suggest?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 335,
                columns: new[] { "AnswerSQL", "AppAffinity", "Source", "SuggestionText" },
                values: new object[] { "SELECT Title, ServiceInScopeDescription, [Function], SubFunction FROM TSAItems", "CE4-TSA", "ey-guidance", "What are examples for TSAs?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 337,
                columns: new[] { "AnswerSQL", "AppAffinity", "Source", "SuggestionText" },
                values: new object[] { "SELECT DISTINCT _TemplateFile FROM WorkPlan", "PROJECT_LEVEL", "ey-guidance", "What PMO workplan templates are available?" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 361, null, "CE4-TSA", null, "System", true, "internet", "Provides templates of TSA.", null, "System", true },
                    { 362, null, "CE4-TSA", null, "System", true, "internet", "What should be the typical duration for TSA?", null, "System", true },
                    { 363, null, "CE4-TSA", null, "System", true, "internet", "Things I should keep in mind for longer duration TSAs?", null, "System", true },
                    { 364, null, "PROJECT_LEVEL", null, "System", true, "internet", "Generate a basic workplan template for my project.", null, "System", true },
                    { 365, null, "PROJECT_LEVEL", null, "System", true, "internet", "What are the key risks for a {ProjectType} project?", null, "System", true },
                    { 366, null, "PROJECT_LEVEL", null, "System", true, "internet", "What are the key milestones for a {ProjectType} project?", null, "System", true },
                    { 367, null, "PROJECT_LEVEL", null, "System", true, "internet", "What are the best practices to run weekly status meetings?", null, "System", true },
                    { 368, null, "PROJECT_LEVEL", null, "System", true, "internet", "What are the best practices to build workplan, and track dependencies?", null, "System", true }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 81,
                columns: new[] { "AnswerSQL", "AppAffinity", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT 'Total Top Down Target' AS KPI,  FORMAT((SUM(VTE.HeadcountCostReductionEst)+SUM(VTE.NonHeadcountCostReductionEst)+SUM(VTE.RevenueGrowthEstimate))/1000000,'N2') AS 'Value (Million)'  FROM ValueCaptureTopDownEstimates VTE", "CE4-VC", true, "What are our targets for this engagement?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 82,
                columns: new[] { "AnswerSQL", "AppAffinity", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT S.Title, COUNT(VI.ID) AS InitiativeCount FROM ValueCaptureStages S LEFT JOIN ValueCaptureInitiatives VI ON S.ID = VI.ValueCaptureStageId LEFT JOIN UserProfiles UP on UP.ID = VI.ItemOwnerId Where UP.EMail = '{Username}' GROUP BY S.Title ", "CE4-VC", true, "How are my initiatives doing?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 83,
                columns: new[] { "AnswerSQL", "AppAffinity", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT RI.Title FROM RisksAndIssuesToValueCaptureInitiativesForValueCaptureInitiativeIDs RIV JOIN ValueCaptureInitiatives VI ON VI.ID = RIV.ValueCaptureInitiativeId JOIN RisksAndIssues RI ON RI.ID = RIV.RisksAndIssueId JOIN UserProfiles U ON U.ID = VI.ItemOwnerId WHERE U.Email = '{Username}' ", "CE4-VC", true, "Are there any risks or issues with initiatives that I’m responsible for?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 84,
                columns: new[] { "AnswerSQL", "AppAffinity", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "select VI.Title from ValueCaptureInitiatives VI LEFT JOIN UserProfiles U on U.ID = VI.ItemOwnerId where U.EMail = '{Username}' ", "CE4-VC", true, "How  many initiatives are assigned to me?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 85,
                columns: new[] { "AnswerSQL", "AppAffinity", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT VI.Title  FROM ValueCaptureInitiatives VI LEFT JOIN ValueCaptureTypes VT ON VT.ID = VI.ValueCaptureTypeId LEFT JOIN UserProfiles U ON U.ID = VI.ItemOwnerId WHERE VT.ID = 1 AND U.EMail = '{Username}' ", "CE4-VC", true, "Give my cost reduction initiatives.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 86,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT SUM(ISNULL(VT.RevenueGrowthEstimate,0)) [RevenueGrowthTarget] FROM [ValueCaptureTopDownEstimates] VT LEFT JOIN ProjectTeams PT ON PT.ID = VT.ProjectTeamId WHERE PT.Title = {ProjectTeam}", "CE4-VC", "What are the revenue growth targets for Sales & Marketing?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 87,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT SUM(ISNULL(VT.CostToAchieveEstimate,0)) [CostToAchieveTarget] FROM [ValueCaptureTopDownEstimates] VT LEFT JOIN ProjectTeams PT ON PT.ID = VT.ProjectTeamId WHERE PT.Title ={ProjectTeam}", "CE4-VC", "What are the cost to achieve targets for R&D?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 88,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT S.Title [Value Capture Stage] , COUNT(VI.ID) [No. of Initiatives] FROM ValueCaptureInitiatives VI LEFT JOIN ProjectTeams PT ON PT.ID = VI.ProjectTeamId LEFT JOIN ValueCaptureStages S ON S.ID = VI.ValueCaptureStageId WHERE PT.Title = {ProjectTeam} GROUP BY S.Title", "CE4-VC", "How many initiatives are there in IT across different stages?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 95,
                columns: new[] { "AnswerSQL", "SuggestionText" },
                values: new object[] { "SELECT SUM(VTE.NonHeadcountCostReductionEst) + SUM(VTE.RevenueGrowthEstimate) + SUM(VTE.HeadcountCostReductionEst) 'Total Top Down Target Value' FROM ValueCaptureTopDownEstimates VTE ", "What is the Total Top Down Target Value?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 102,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT UP.Title AS UserProfile, COUNT(VC.ID) AS ValueCaptureOwnerwiseCount FROM ValueCaptureInitiatives VC LEFT JOIN UserProfiles UP ON UP.ID = VC.ItemOwnerId WHERE VC.ItemOwnerId IS NOT NULL GROUP BY VC.ItemOwnerId, UP.Title", true, "Show me initiatives count by owner.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 104,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT COUNT(VCI.ID) as IdentifiedInitiatives FROM ValueCaptureInitiatives VCI LEFT JOIN ValueCaptureStages VCS ON VCS.ID = VCI.ValueCaptureStageId WHERE VCS.Title = 'Identified'", false, "How many initiatives are identified?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 105,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT COUNT(VCI.ID) as ApprovedInitiatives FROM ValueCaptureInitiatives VCI LEFT JOIN ValueCaptureStages VCS ON VCS.ID = VCI.ValueCaptureStageId WHERE VCS.Title = 'Approved' ", false, "How many initiatives have been approved?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 112,
                columns: new[] { "AnswerSQL", "SuggestionText" },
                values: new object[] { "SELECT VCS.Title AS ValueCaptureStage, COUNT(VC.ID) AS ValueCaptureStageCount FROM ValueCaptureInitiatives VC LEFT JOIN ValueCaptureStages VCS ON VCS.ID = VC.ValueCaptureStageId GROUP BY VC.ValueCaptureStageId, VCS.Title", "Show me initiatives count by stage." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 120,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT  SUM(ISNULL(VTE.CostToAchieveEstimate,0)) AS CostToAchive FROM  ValueCaptureTopDownEstimates VTE", true, "What is the Total Cost to Achieve Target?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 122,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT A.Amount as [Client Baseline PnL Amount], A.FinancialLineItem as FinancialLineItem FROM( SELECT F.ID, F.Ordinal, F.Title FinancialLineItem , SUM(C.Amount)/1000000 Amount FROM ValueCaptureFinancialLineItems F LEFT JOIN CostCenters C ON C.FinancialLineItemId = F.ID  GROUP BY F.ID, F.Title, F.Ordinal ) A WHERE A.Amount IS NOT NULL", false, "What is my program Client Baseline PnL?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 123,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT VCRI.Title AS [Recommended Initiatives List] FROM ValueCaptureRecommendedInitiatives VCRI", false, "List all recommended initiatives for my program.", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 124,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT 	SUM(a.[Total Top Down Target Value]) AS [Top Down Targets],      SUM(b.[Bottom Up Initiatives Value]) AS [Bottom Up Initiatives Value], 	( SUM(b.[Bottom Up Initiatives Value])-SUM(a.[Total Top Down Target Value])) AS Variance FROM ( SELECT   SUM(ISNULL(VCTDE.HeadcountCostReductionEst, 0)) + SUM(ISNULL(VCTDE.NonHeadcountCostReductionEst, 0))        + SUM(ISNULL(VCTDE.RevenueGrowthEstimate, 0)) AS [Total Top Down Target Value] FROM ValueCaptureTopDownEstimates VCTDE) a, ( select SUM(Amount)*12 as [Bottom Up Initiatives Value]  FROM vwUnpivotEstimates where MYear='Y3M12' AND Recurring =1 ) b ", false, "Compare Top Down Targets vs Bottom Up Initiatives for my project.", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 125,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "   SELECT ISNULL(SUM(Act.AMOUNT),0.0) AS [Cumulative One Time Cost Amount] 			   FROM vwUnpivotActuals Act 			   LEFT JOIN ValueCaptureImpactTypes VCIT ON Act.ValueCaptureImpactTypeID=VCIT.ID 			   LEFT JOIN ValueCaptureInitiatives VCI ON Act.ValueCaptureInitiativeID=VCI.ID 			   WHERE VCIT.PositiveOrNegativeValues='Negative' 			   AND Act.Recurring<>1 			   AND VCI.Title = '{ValueCaptureInitiative}'", false, "What is cumulative one-time cost for all initiatives?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 134,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT  ISNULL(SUM(UE.Amount)/1000000,0) AS TotalNetSales FROM ValueCaptureEstimates VE LEFT JOIN ValueCaptureFinancialLineItems FL ON FL.ID = VE.FinancialLineItemId LEFT JOIN ValueCaptureInitiatives VI ON VI.id = VE.ValueCaptureInitiativeId LEFT JOIN vwUnpivotEstimates UE ON UE.ID = VE.ID LEFT JOIN ValueCaptureFinancialLineItemTypes FLT ON FLT.ID = FL.FinancialLineItemTypeId WHERE FLT.Title = 'PnL' AND FL.Title in ('Net sales')", false, "In the PnL, what is my net sales?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 137,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT  	ISNULL(SUM(UE.Amount)/1000000,0) AS [EBITA & Net Income] FROM      ValueCaptureEstimates VE LEFT JOIN      ValueCaptureFinancialLineItems FL ON FL.ID = VE.FinancialLineItemId LEFT JOIN      ValueCaptureInitiatives VI ON VI.id = VE.ValueCaptureInitiativeId LEFT JOIN  	vwUnpivotEstimates UE ON UE.ID = VE.ID LEFT JOIN 	ValueCaptureFinancialLineItemTypes FLT ON FLT.ID = FL.FinancialLineItemTypeId LEFT JOIN 	ValueCaptureFinancialLineItemGroups FLG ON FLG.ID = FL.FinancialLineItemGroupId WHERE      FLT.Title = 'PnL' AND FLG.Title in ('EBITDA','Net Income') ", true, "In the PnL, what is my EBITDA and Net Income?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 138,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT  	ISNULL(SUM(UE.Amount)/1000000,0) AS [Total Assets] FROM      ValueCaptureEstimates VE LEFT JOIN      ValueCaptureFinancialLineItems FL ON FL.ID = VE.FinancialLineItemId LEFT JOIN      ValueCaptureInitiatives VI ON VI.id = VE.ValueCaptureInitiativeId LEFT JOIN  	vwUnpivotEstimates UE ON UE.ID = VE.ID LEFT JOIN 	ValueCaptureFinancialLineItemTypes FLT ON FLT.ID = FL.FinancialLineItemTypeId LEFT JOIN 	ValueCaptureFinancialLineItemGroups FLG ON FLG.ID = FL.FinancialLineItemGroupId WHERE      FLT.Title = 'Balance Sheet'  AND FLG.Title in ('Total Current Assets','Total Non-Current Assets') ", true, "In the Balance Sheet, what is my Total Assets?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 140,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT  	ISNULL(SUM(UE.Amount)/1000000,0) AS [Total Equity] FROM      ValueCaptureEstimates VE LEFT JOIN      ValueCaptureFinancialLineItems FL ON FL.ID = VE.FinancialLineItemId LEFT JOIN  	vwUnpivotEstimates UE ON UE.ID = VE.ID LEFT JOIN 	ValueCaptureFinancialLineItemTypes FLT ON FLT.ID = FL.FinancialLineItemTypeId LEFT JOIN 	ValueCaptureFinancialLineItemGroups FLG ON FLG.ID = FL.FinancialLineItemGroupId WHERE      FLT.Title = 'Balance Sheet'  AND FLG.Title in ('Equity') ", true, "In the Balance Sheet, what is my Total Equity?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 147,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT TOP 5 A.Initiatives, A.Amount FROM( SELECT VI.Title Initiatives ,sum(VE.Amount) Amount FROM vwUnpivotActuals VE LEFT JOIN ValueCaptureInitiatives VI ON VI.id = VE.ValueCaptureInitiativeId LEFT JOIN ValueCaptureImpactTypes VIT ON VIT.ID = VE.ValueCaptureImpactTypeid GROUP BY VI.Title,VE.Amount ) A WHERE A.Amount > 0 ORDER BY A.Amount DESC", false, "List out top 5 initiatives that are positively impacting PnL.", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 149,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "	SELECT TOP 5  		VI.Title [top 5 most complex initiatives] 	FROM  		ValueCaptureInitiatives VI 	LEFT JOIN  		ValueCaptureImpacts VIM ON VIM.ID = VI.ValueCaptureImpactid 	WHERE  		VIM.ID in (3) 	ORDER BY  		VI.ComplexityScore DESC", true, "List out top 5 most complex initiatives that have low financial impact.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 158,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT SUM(T.FTEs) [FTEs part of the top down targets for EMEIA] FROM ValueCaptureTopDownEstimates T     LEFT JOIN Regions R         ON R.ID = T.RegionID WHERE R.Title = 'EMEIA'", false, "How many FTEs are part of the top down targets for EMEIA?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 159,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT VI.Title [Initiatives with Benefit score over 75] FROM ValueCaptureInitiatives VI LEFT JOIN ProjectTeams PT ON PT.ID = VI.ProjectTeamId WHERE CAST(VI.BenefitScore AS INT) > 75 AND PT.Title IN ('HR')", false, "Which HR iniatives have a benefit score over 75?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 160,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT 	VI.Title [Initiatives that have Risk associated with them] FROM 	ValueCaptureInitiatives VI LEFT JOIN  	ValueCaptureStages VS ON VS.ID = VI.ValueCaptureStageId LEFT JOIN  	RisksAndIssuesToValueCaptureInitiativesForValueCaptureInitiativeIDs VIR ON VIR.ValueCaptureInitiativeId = VI.ID LEFT JOIN 	RisksAndIssues RI ON RI.ID = VIR.RisksAndIssueId WHERE  	RI.IssueRiskCategory IN ('Risk') 	AND VS.Title IN ('Committed')", false, "List out all Committed Iniatives that have a risk associated with them.", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 163,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT 	COUNT(VI.ID) FROM 	ValueCaptureInitiatives VI LEFT JOIN 	UserProfiles UP ON UP.ID = VI.ItemOwnerId WHERE  	UP.EMail = '{Username}'", true, "How many iniatives are assigned to me?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 164,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT  PT.Title ProjectTeam,SUM(ISNULL(VTE.NonHeadcountCostReductionEst,0)) NonHeadcountCostReductionTarget  FROM   ValueCaptureTopDownEstimates VTE LEFT JOIN   ProjectTeams PT ON PT.ID = VTE.Projectteamid GROUP BY   PT.Title", true, "Provide the total non-headcount cost reduciton targets listed out by project team.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 167,
                columns: new[] { "AnswerSQL", "AppAffinity", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT DISTINCT S.Title FROM NodesToSystemsForEnablerSystems NS LEFT JOIN Nodes N ON N.ID = NS.NodesId LEFT JOIN Systems S ON S.ID = NS.SystemsId LEFT JOIN TransactionStates T ON T.ID = N.TransactionStateId WHERE T.[Key] = 'DAY_ONE' ", "CE4-OM", true, "How many systems are tagged to Day 1 processes?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 168,
                columns: new[] { "AnswerSQL", "AppAffinity", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT DISTINCT A.Title FROM NodesToAssetsForEnablerAssets NA LEFT JOIN Nodes N ON N.ID = NA.NodesId LEFT JOIN Assets A ON A.ID = NA.AssetsId LEFT JOIN TransactionStates T ON T.ID = N.TransactionStateId WHERE T.[Key] = 'DAY_ONE' AND A.Title IS NOT NULL ", "CE4-OM", true, "How many assets are tagged to Day 1 processes? ", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 170,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT ns.Title, a.TotalCount FROM ( SELECT COUNT(Title) AS TotalCount, BusinessEntityId FROM Nodes nds WHERE NodeTypeId = 3 GROUP BY BusinessEntityId ) a INNER JOIN Nodes ns ON a.BusinessEntityId = ns.ID", "CE4-OM", "Can you provide me number of processes by op model?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 171,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT ns.Title, a.TotalCount FROM ( SELECT COUNT(N.Title) AS TotalCount, BusinessEntityId FROM Nodes N LEFT JOIN TransactionStates T ON T.ID = N.TransactionStateId WHERE NodeTypeId = 3 AND T.[Key] = 'CURRENT_STATE' GROUP BY BusinessEntityId ) a INNER JOIN Nodes ns ON a.BusinessEntityId = ns.ID ", "CE4-OM", "How many processes we have in current state?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 196,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT N.Title [List of processes for CurrentState where ownership is not present] FROM Nodes N JOIN TransactionStates T ON T.ID = N.TransactionStateId WHERE T.[Key] = 'CURRENT_STATE'   AND N.NodeTypeId = 3   AND N.ID NOT IN (     SELECT DISTINCT NTO.NodeId     FROM Nodes N1     LEFT JOIN NodesToOwnersForOwnerNew NTO ON NTO.NodeId = N1.ID 	where NTO.NodeId is not null   )", false, "For Current State, list all processes that doesn't have any ownership.", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 198,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { ";WITH GetSelectedFunction AS (SELECT id,            Title,            NodeParentID,            NodeTypeId,            HierId = 1     FROM Nodes  n   WHERE NodeParentID IS NULL     UNION ALL     SELECT nds.id,  nds.Title,   nds.NodeParentID, nds.NodeTypeId, HierId = HierId + 1     FROM Nodes nds, GetSelectedFunction  where nds.NodeParentID = GetSelectedFunction.id    ),       PG_Hierarchy ([Functions], NodeParentID, ID, Title, Parent, ParentID, NodeTypeId) AS (SELECT ROOT.Title [Functions],            ROOT.NodeParentID,            ROOT.id,            ROOT.Title,            ROOT.Title,            ROOT.ID AS ParentID,            ROOT.NodeTypeId     FROM GetSelectedFunction ROOT     WHERE HierId = 2     UNION ALL     SELECT PARENT.[Functions],            CHILD.NodeParentID,            CHILD.ID,            CHILD.Title,            PARENT.TITLE,            PARENT.ID,            CHILD.NodeTypeId     FROM PG_Hierarchy PARENT,          Nodes CHILD     where PARENT.id = CHILD.NodeParentID    )  , ProcessCTE AS (SELECT DISTINCT         P.Functions,         P.Title Processes,         P.ID     FROM     (SELECT * FROM PG_Hierarchy pgh WHERE NodeTypeId = 2) SF         LEFT JOIN         (SELECT * FROM PG_Hierarchy pg WHERE NodeTypeId = 3) P             ON P.NodeParentID = SF.ID     WHERE P.Title IS NOT NULL    ) SELECT TOP 1     Functions AS [Function with highest number of processes] FROM (     SELECT Functions,            COUNT(ID) as [Process Count]     FROM ProcessCTE  tc   GROUP BY Functions ) A order by [Process Count] desc    ", false, "Which function has the highest number of processes?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 199,
                columns: new[] { "AnswerSQL", "SuggestionText" },
                values: new object[] { "SELECT     N.Title AS [List of Processes with Disposition as TSA] FROM   Nodes   N   LEFT JOIN     NodesToDispositionsForDispositionNew NTD             ON NTD.NodeId = N.ID     LEFT JOIN         Dispositions  D ON NTD.DispositionId = D.ID WHERE     D.Title = 'TSA'     AND N.NodeTypeId = 3", "List down all Processes which have their disposition set as TSA." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 203,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { ";WITH GetSelectedFunction AS (SELECT id,            Title,            NodeParentID,            NodeTypeId,            HierId = 1     FROM Nodes nd    WHERE NodeParentID IS NULL     UNION ALL     SELECT nds.id,            nds.Title,            nds.NodeParentID,            nds.NodeTypeId,            HierId = HierId + 1     FROM Nodes nds,          GetSelectedFunction     where nds.NodeParentID = GetSelectedFunction.id    ),       PG_Hierarchy ([Functions], NodeParentID, ID, Title, Parent, ParentID, NodeTypeId) AS (SELECT ROOT.Title [Functions],            ROOT.NodeParentID,            ROOT.id,            ROOT.Title,            ROOT.Title,            ROOT.ID AS ParentID,            ROOT.NodeTypeId     FROM GetSelectedFunction ROOT     WHERE HierId = 2     UNION ALL     SELECT PARENT.[Functions],            CHILD.NodeParentID,            CHILD.ID,            CHILD.Title,            PARENT.TITLE,            PARENT.ID,            CHILD.NodeTypeId     FROM PG_Hierarchy PARENT,          Nodes CHILD     where PARENT.id = CHILD.NodeParentID    ), ProcessCTE AS (SELECT DISTINCT         P.Functions,         P.Title Processes,         P.ID AS [ProcessID]     FROM     (SELECT * FROM PG_Hierarchy pg WHERE NodeTypeId = 2) SF         LEFT JOIN         (SELECT * FROM PG_Hierarchy pg WHERE NodeTypeId = 3) P             ON P.NodeParentID = SF.ID     WHERE P.Title IS NOT NULL    ) SELECT ISNULL(Geo.Title, 'Not Assigned') AS [Geographic Coverages],        COUNT(P.ProcessID) AS [Total Number of Process in Real Estate] FROM ProcessCTE P     LEFT JOIN ProcessAttributes PA         ON P.ProcessID = PA.NodeId     LEFT JOIN GeographicCoverages Geo         ON PA.GeographicCoverageId = Geo.ID WHERE P.Functions ='{FunctionName}' GROUP BY Geo.Title", false, "What is total number of processes in Real Estate grouped by geographic coverage?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 205,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT     O.Title     AS [Process Owner],     COUNT(N.ID) AS [Process Distribution] FROM     Nodes      N     LEFT JOIN         Owners O             ON N.OwnerId = O.ID WHERE     N.NodeTypeId = 3 GROUP BY     O.Title ", true, "Provide process owner distribution for my project.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 207,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { ";WITH GetSelectedFunction AS (SELECT id,            Title,            NodeParentID,            NodeTypeId,            HierId = 1     FROM Nodes nd    WHERE NodeParentID IS NULL     UNION ALL     SELECT nds.id,            nds.Title,            nds.NodeParentID,            nds.NodeTypeId,            HierId = HierId + 1     FROM Nodes nds,          GetSelectedFunction     where nds.NodeParentID = GetSelectedFunction.id    ),       PG_Hierarchy ([Functions], NodeParentID, ID, Title, Parent, ParentID, NodeTypeId) AS (SELECT ROOT.Title [Functions],            ROOT.NodeParentID,            ROOT.id,            ROOT.Title,            ROOT.Title,            ROOT.ID AS ParentID,            ROOT.NodeTypeId     FROM GetSelectedFunction ROOT     WHERE HierId = 2     UNION ALL     SELECT PARENT.[Functions],            CHILD.NodeParentID,            CHILD.ID,            CHILD.Title,            PARENT.TITLE,            PARENT.ID,            CHILD.NodeTypeId     FROM PG_Hierarchy PARENT,          Nodes CHILD     where PARENT.id = CHILD.NodeParentID    )  ,        ProcessCTE AS (SELECT DISTINCT         P.Functions,         P.Title Processes,         P.ID AS [ProcessID]     FROM     (SELECT * FROM PG_Hierarchy pg WHERE NodeTypeId = 2) SF         LEFT JOIN         (SELECT * FROM PG_Hierarchy pg WHERE NodeTypeId = 3) P             ON P.NodeParentID = SF.ID     WHERE P.Title IS NOT NULL    ) SELECT P.Processes,        ISNULL(S.Title, 'Not Assigned') AS [Systems],        ISNULL(TPA.Title, 'Not Assigned') AS [Third Party Agreements] FROM ProcessCTE P     LEFT JOIN NodesToThirdPartyAgreementsForEnablerTpa NTPA         ON P.ProcessID = NTPA.NodesId     LEFT JOIN ThirdPartyAgreements TPA         ON NTPA.ThirdPartyAgreementsId = TPA.ID     LEFT JOIN NodesToSystemsForEnablerSystems NSys         ON NSys.NodesId = P.ProcessID     LEFT JOIN Systems S         ON NSys.SystemsId = S.ID", false, "List all details for processes and systems, third party agreements linkages.", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 208,
                columns: new[] { "AnswerSQL", "SuggestionText" },
                values: new object[] { "SELECT A.Title Assest,        P.Title LinkedProcess FROM Assets A     LEFT JOIN ProcessAssetLinks PA         ON PA.AssetId = A.ID     LEFT JOIN Nodes P         ON P.ID = PA.ProcessId     LEFT JOIN NodeTypes NType         ON P.NodeTypeId = NType.ID WHERE NType.Title = 'Process'", "List the Assets and their linked processes." });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 209,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT N.Title OpModel, BP.Title  EndToEndProcess FROM BusinessProcesses BP  LEFT JOIN Nodes N ON N.ID = BP.NodeId  WHERE N.NodeTypeId = 1", true, "Are there any end-to-end business processes in this op model?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 212,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT     N.Title AS [List of Process which doesn''t have ownership] FROM     Nodes                 N     JOIN         TransactionStates T             ON T.ID = N.TransactionStateId WHERE     OwnerId IS NULL     AND N.NodeTypeId = 3", true, "List down all processes with no Owners assigned.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 218,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT N.Title AS [List of Processes tagged as ParentCo in Current State with Disposition set as TSA ] FROM Nodes N     LEFT JOIN NodesToOwnersForOwnerNew NTO         on N.ID = NTO.NodeId     LEFT JOIN Owners O         ON O.ID = NTO.OwnerId     LEFT JOIN NodeTypes NT         ON N.NodeTypeId = NT.ID     LEFT JOIN TransactionStates TS         ON N.TransactionStateId = TS.ID     LEFT JOIN NodesToDispositionsForDispositionNew NTD         ON N.ID = NTD.NodeId     LEFT JOIN Dispositions D         on NTD.DispositionId = D.ID WHERE NT.Title = 'Process'       AND TS.[Key] = 'CURRENT_STATE'       AND O.Title = 'Parent Co'       AND D.Title = 'TSA'", true, "Can you please list the processes which are tagged as 'ParentCo' in Current state having disposition set as 'TSA'?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 219,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT     Title AS [Systems not tagged in any process] FROM     Systems s WHERE     ID NOT IN (                   SELECT DISTINCT                       SystemsId                   FROM                       Nodes                               N                       LEFT JOIN                           NodesToSystemsForEnablerSystems NSS                               ON N.ID = NSS.NodesId  					  LEFT JOIN TransactionStates T ON T.ID = N.TransactionStateId                    WHERE T.Title= 'Day 1' AND                        N.NodeTypeId = 3               )", true, "can you please list all systems which are not tagged to any process in Day 1 op model?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 222,
                columns: new[] { "AnswerSQL", "SuggestionText" },
                values: new object[] { ";WITH  GetSelectedFunction AS  (  SELECT id,Title,NodeParentID, NodeTypeId, HierId = 1 FROM Nodes n   WHERE NodeParentID IS NULL   UNION ALL         SELECT    nds.id,nds.Title,nds.NodeParentID,  nds.NodeTypeId,  HierId = HierId+1 FROM Nodes nds, GetSelectedFunction   WHERE nds.NodeParentID = GetSelectedFunction.id )  ,PG_Hierarchy([Functions],NodeParentID, ID,Title,Parent,ParentID,NodeTypeId) AS  (  SELECT ROOT.Title [Functions],ROOT.NodeParentID,ROOT.id,ROOT.Title,ROOT.Title,ROOT.ID AS ParentID, ROOT.NodeTypeId FROM GetSelectedFunction ROOT WHERE HierId = 2    UNION ALL         SELECT  PARENT.[Functions],CHILD.NodeParentID,CHILD.ID,CHILD.Title,PARENT.TITLE,PARENT.ID,CHILD.NodeTypeId  FROM PG_Hierarchy PARENT ,Nodes   CHILD  WHERE  PARENT.id=CHILD.NodeParentID  ), ProcessCTE AS (  SELECT DISTINCT P.Functions, P.Title Processes, P.ID  FROM (SELECT * FROM PG_Hierarchy pg WHERE NodeTypeId = 2) SF 	LEFT JOIN (SELECT * FROM PG_Hierarchy gg WHERE NodeTypeId = 3) P ON P.NodeParentID = SF.ID WHERE P.Title IS NOT NULL  )   SELECT Top 1 [Functions] AS [Function with Highest Number of Live Without]  FROM ProcessCTE pp WHERE ID IN (	SELECT NodeId 				FROM NodesToDispositionsForDispositionNew ND  				LEFT JOIN Dispositions D ON D.ID = DispositionID  				WHERE D.Title = 'Live without'			 				) GROUP BY [Functions] ORDER BY  COUNT(*) DESC", "which function has the highest number of 'Live without'?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 224,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { ";WITH PG_Hierarchy AS (SELECT id,            Title,            NodeParentID,            TransactionStateID,            HierId = 1     FROM Nodes   n  WHERE NodeParentID IS NULL     UNION ALL     SELECT nds.id,            nds.Title,            nds.NodeParentID,            nds.TransactionStateId,             HierId = HierId + 1     FROM Nodes nds,          PG_Hierarchy     WHERE nds.NodeParentID = PG_Hierarchy.id    ),       ProcessCTE AS (SELECT DISTINCT          F.Title AS [Functions],         f.id AS FunctionID     FROM     (SELECT * FROM PG_Hierarchy pp WHERE HierId = 2) F         LEFT JOIN         (SELECT * FROM PG_Hierarchy gg WHERE HierId = 3) SF             ON F.ID = SF.NodeParentID    ) SELECT Top 1     Functions as [Function with Highest Number of Enablers],     [Enablers Count] FROM (     SELECT P.Functions,            COUNT(DISTINCT TPA.ID) + COUNT(DISTINCT S.ID) + COUNT(DISTINCT Asset.ID) + COUNT(DISTINCT Roles.ID) AS [Enablers Count]     FROM ProcessCTE P         LEFT JOIN NodesToThirdPartyAgreementsForEnablerTpa NTPA           ON P.FunctionID = NTPA.NodesId         LEFT JOIN ThirdPartyAgreements TPA             ON NTPA.ThirdPartyAgreementsId = TPA.ID          LEFT JOIN NodesToSystemsForEnablerSystems NSys              ON NSys.NodesId = P.FunctionID         LEFT JOIN Systems S             ON NSys.SystemsId = S.ID         LEFT JOIN NodesToAssetsForEnablerAssets NAsset              ON NAsset.NodesId = P.FunctionID         LEFT JOIN Assets Asset             ON Asset.ID = NAsset.AssetsId          LEFT JOIN NodesToRolesForEnablerRoles NRole --Roles              ON NAsset.NodesId = P.FunctionID         LEFT JOIN OrgRolesMaster Roles             ON Roles.ID = NRole.RolesId     GROUP BY P.Functions ) A ORDER BY [Enablers Count] DESC", true, "Which function has the highest number of enablers tagged to them? and how many?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 229,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT O.Title [Owners], COUNT(N.ID) [No of Processes]  FROM Nodes N  LEFT JOIN NodeTypes NT ON N.NodeTypeId = NT.ID  LEFT JOIN NodesToOwnersForOwnerNew NOS ON NOS.NodeId = N.ID  LEFT JOIN Owners O ON O.ID = NOS.OwnerId  WHERE NT.Title = 'Process'  GROUP BY O.Title", true, "Provide a count of all processes by owner.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 230,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT  	R.Title Regions 	, COUNT(D.DispositionId) [Count of Disposition]  FROM NodesToDispositionsForDispositionNew D     JOIN Nodes N ON D.NodeId = N.ID 	JOIN TransactionStates S ON S.ID = N.TransactionStateId  	LEFT JOIN NodeTypes NT ON NT.ID = N.NodeTypeId  	LEFT JOIN Regions R ON R.ID = N.CountryRegionID  WHERE NT.Title = 'Process'  	AND S.[Key] = 'DAY_ONE' GROUP BY R.Title", true, "Show me the count of dispositions in Day 1 model by assigned region.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 231,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT N.Title [Processes with no owner assigned] FROM Nodes N  LEFT JOIN NodeTypes NT ON N.NodeTypeId = NT.ID WHERE NT.Title = 'Process'    AND N.ID NOT IN (     SELECT DISTINCT NTO.NodeId     FROM Nodes N1     LEFT JOIN NodesToOwnersForOwnerNew NTO ON NTO.NodeId = N1.ID 	WHERE NTO.NodeId is not null   )", true, "List all processes that do not have an owner assigned.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 240,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT N.Title [Process groups are not started on Followup Calls for Current State] FROM Nodes N     LEFT JOIN Nodetypes NT         ON NT.ID = N.NodeTypeId     LEFT JOIN NodeTrackers NTC         ON NTC.NodeID = N.ID     LEFT JOIN NodeTrackerStatuses NTS         ON NTS.NodeTrackerID = NTC.ID     LEFT JOIN TransactionStates T         ON T.ID = N.TransactionStateID WHERE N.NodeOnTracker = 1       AND NT.Title = 'Process Group'       AND T.[Key] = 'CURRENT_STATE'       AND N.ID NOT IN (                           SELECT N.ID ProcessGroupID                           FROM Nodes N                               LEFT JOIN Nodetypes NT                                   ON NT.ID = N.NodeTypeId                               LEFT JOIN NodeTrackers NTC                                   ON NTC.NodeID = N.ID                               LEFT JOIN NodeTrackerStatuses NTS                                   ON NTS.NodeTrackerID = NTC.ID                               LEFT JOIN TransactionStates T                                   ON T.ID = N.TransactionStateID                           WHERE N.NodeOnTracker = 1                                 AND NT.Title = 'Process Group'                                 AND T.[Key] = 'CURRENT_STATE'                                 AND NTS.Title = 'FollowUp Call'                       )", false, "Which process groups are not started on Followup Calls for Current State?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 241,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { ";WITH GetSelectedFunction AS (SELECT id,            Title,            NodeParentID,            HierId = 1     FROM Nodes n    WHERE NodeParentID IS NULL      UNION ALL     SELECT nds.id,            nds.Title,            nds.NodeParentID,            HierId = HierId + 1     FROM Nodes nds,          GetSelectedFunction     where nds.NodeParentID = GetSelectedFunction.id    ) SELECT O.Title [Client Owner for HR] FROM GetSelectedFunction N 	LEFT JOIN NodesToOwnersForOwnerNew NOS ON NOS.NodeId = N.ID  	LEFT JOIN Owners O ON O.ID = NOS.OwnerId  WHERE N.HierId = 2 AND N.Title = 'HR'", false, "Who is the Client owner for HR?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 248,
                columns: new[] { "AnswerSQL", "AppAffinity", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT PT.Title, Count(1) as 'Number Of TSAs' from TSAItems T LEFT JOIN ProjectTeams PT on PT.ID = T.ProjectTeamId Group by PT.ID, PT.Title ", "CE4-TSA", true, "How many TSAs does each team have?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 249,
                columns: new[] { "AnswerSQL", "AppAffinity", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT    TST.Title as [Phase],    COUNT(TC.ID) AS [# TSAs across different phases] FROM    TSAItems TC    LEFT JOIN TSAPhases TST ON TC.PhaseID = TST.ID  Group BY    TST.Title ", "CE4-TSA", true, "List the number of TSAs across different phases.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 256,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT   Title DefaultCurrency FROM  TSACurrencies tc WHERE CurrencyCode ='{CurrencyCode}'", false, "What is the default currency setting?", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 257,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT   CurrencyExchangeRateToUSD  FROM  TSACurrencies t WHERE CurrencyCode ={CurrencyCode}", false, "List the exchange rates we setup for the default currency on my project.", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 259,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT    DISTINCT SF.Title as [SubFunctions To Be Configured] FROM    TSAReviewers TR    LEFT JOIN SubFunctions SF on SF.ID = TR.SubFunctionId ", true, "In Reviewer Assignments, what sub-functions need to be configured for my project?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 261,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT     Title        AS [Billing Period Name],     DeadlineDate AS [Contribution Deadlines] FROM     TSABillingPeriods t", true, "List the billing periods with their Contribution deadlines.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 263,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT     f.title   AS [Functions],     (t.TSAItemFTECostForServiceDurationUSD + t.MarkupOnFTECostUSD + t.ExternalMaterialCostUSD) AS [TSA Costs] FROM     TSAItems        AS t     LEFT OUTER JOIN         TSAStatuses s             ON t.tsaitemtsastatusid = s.id     LEFT OUTER JOIN         Functions   f             ON t.FunctionId = f.id WHERE     s.title <> 'Canceled'     AND t.Duration IS NOT NULL", true, "What my TSA costs by  function?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 266,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT     [year]                               AS [By Year],     ROUND(SUM(fte_cost_per_month), 2)    AS [TSA FTE Cost for Selected Year],     ROUND(SUM(nonfte_cost_per_month), 2) AS [TSA Non-FTE Cost for Selected Year] FROM     vwTSACostWaterfall wf WHERE      [year] = '{Year}' GROUP BY     [year]", false, "Break down the total TSA cost for this year by FTE and Non-FTE cost.", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 272,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT TSA.Title AS [TSAs with Open Risks] FROM TSAItems TSA     LEFT JOIN RisksAndIssues RI         ON TSA.ID = RI.TSAItemId     LEFT JOIN Statuses S         ON RI.ProgressId = S.ID WHERE S.[Key] NOT IN ( 'COMPLETED', 'CLOSED', 'CANCELLED', 'DELETED', 'REJECTED',  'ON_HOLD')", true, "List out TSA with Open risks.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 274,
                columns: new[] { "AnswerSQL", "SuggestionText" },
                values: new object[] { "SELECT UP.Title AS [Buyer Side Reviewer for Finance TSAs] FROM TSAReviewers TRev     LEFT JOIN Functions F         ON TRev.FunctionId = F.ID     LEFT JOIN UserProfiles UP         ON TRev.ProviderApproverId = UP.ID WHERE F.Title ='{FunctionName}'", "Who is the sell side reviewer for finance TSAs?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 281,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT AVG(t.Duration) AS [Average Duration for IT TSAs],        (SUM(t.TSAItemFTECostForServiceDurationUSD) + SUM(t.MarkupOnFTECostUSD) + SUM(t.ExternalMaterialCostUSD)) AS [Cost for IT TSAs] FROM TSAItems AS t     LEFT OUTER JOIN TSAStatuses s         ON t.tsaitemtsastatusid = s.id     LEFT OUTER JOIN Functions f         ON t.FunctionId = f.id WHERE s.title <> 'Canceled'       AND t.Duration IS NOT NULL       AND f.Title = 'IT' GROUP BY f.title", true, "What is the average duration and cost for IT TSAs?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 282,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT TSA.Title AS [TSAs with Behind Schedule / At Risk Tasks Linked] FROM TSAItems TSA     LEFT JOIN Workplan WP         ON TSA.ID = WP.TSAItemId     LEFT JOIN Statuses S         ON WP.WorkPlanTaskStatusId = S.ID WHERE WP.WorkPlanTaskType = 'Task'       AND S.[Key] IN ('BEHIND_SCHEDULE','AT_RISK')", true, "Show me all TSAs that have a linked task that is At Risk or Behind Schedule.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 283,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT TSA.Title AS [TSA Items that need review] FROM TSAItems TSA     LEFT JOIN TSAPhases Stg         ON TSA.PhaseId = Stg.ID WHERE Stg.[Key] IN ( 'ALIGNMENT', 'APPROVAL' )", true, "List all TSAs that need review.", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 286,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT t.Title AS [TSAs are in a local currency that is not US dollar] FROM TSAItems AS t     LEFT OUTER JOIN TSAStatuses s         ON t.tsaitemtsastatusid = s.id     LEFT OUTER JOIN TSACurrencies TSACurr         ON t.TSAItemLocalCurrencyId = TSACurr.ID     LEFT OUTER JOIN Currencies Curr         ON TSACurr.CurrencyID = Curr.ID WHERE Curr.Title <> 'USD ($)'       AND s.title <> 'Canceled'", true, "How many TSAs are in a local currency that is not US dollar?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 298,
                columns: new[] { "AnswerSQL", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT     t.Title AS [TSAs assigned to function due in next 30 days] FROM     TSAItems        AS t     LEFT OUTER JOIN         TSAStatuses s             ON t.tsaitemtsastatusid = s.id     LEFT OUTER JOIN         Functions   f             ON t.FunctionId = f.id WHERE     s.title <> 'Canceled'     AND f.Title='{FunctionName}' 	AND CAST(t.TSAItemEndDate AS DATE) BETWEEN CAST(GETDATE() AS DATE) AND CAST(GETDATE()+30 AS DATE)", false, "List All TSAs assigned to IT due in next 30 days.", false });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 306,
                columns: new[] { "AnswerSQL", "AppAffinity", "IsIncluded", "SuggestionText", "VisibleToAssistant" },
                values: new object[] { "SELECT pt.Title, COUNT(wp.WorkPlanTaskType) AS MilestoneCount  FROM WorkPlan wp  LEFT JOIN ProjectTeams pt ON pt.ID = wp.ProjectTeamId  LEFT JOIN TeamTypes TT on TT.ID = pt.TeamTypeId WHERE wp.WorkPlanTaskType = 'Milestone' AND TT.[Key] = 'PROJECT_MANAGEMENT' GROUP BY pt.Title", "PROJECT_LEVEL", true, "How many milestones does each team have?", true });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 308,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT pt.Title, COUNT(1) AS RiskCount  FROM RisksAndIssues RI  left join ProjectTeams pt on pt.ID = ri.ProjectTeamId LEFT JOIN TeamTypes TT on TT.ID = pt.TeamTypeId WHERE IssueRiskCategory = 'Risk' AND TT.[Key] = 'PROJECT_MANAGEMENT' GROUP BY pt.Title", "PROJECT_LEVEL", "How many risks does each team have?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 315,
                columns: new[] { "AnswerSQL", "AppAffinity", "Source", "SuggestionText" },
                values: new object[] { "SELECT Title FROM ValueCaptureInitiatives WHERE ValueCaptureType = 'Cost Saving' or  ValueCaptureType = 'Cost Reduction'", "CE4-VC", "ey-guidance", "What cost savings levers are available?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 316,
                columns: new[] { "AnswerSQL", "AppAffinity", "Source", "SuggestionText" },
                values: new object[] { "SELECT Title FROM ValueCaptureInitiatives WHERE ValueCaptureType = 'Revenue Growth'", "CE4-VC", "ey-guidance", "What revenue growth levers are available?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 330,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { null, "PROJECT_LEVEL", "What are the best practices to run weekly status meetings with the client?" });
