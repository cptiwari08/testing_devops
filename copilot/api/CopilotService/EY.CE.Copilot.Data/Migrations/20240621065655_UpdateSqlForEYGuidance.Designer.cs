...
namespace EY.CE.Copilot.Data.Migrations
{
    ...
    [Migration("20240621065655_UpdateSqlForEYGuidance")]
    partial class UpdateSqlForEYGuidance
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EY.CE.Copilot.Data.Models.Suggestion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 314,
                            AnswerSQL = "SELECT VCI.Title FROM ValueCaptureInitiatives VCI WHERE VCI.ValueCaptureType = 'Cost Saving' or  VCI.ValueCaptureType = 'Cost Reduction'What are the one-time costs I should be expecting to incur for Supply Chain related initiatives?",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "ey-guidance",
                        ...
                        {
                            ID = 316,
                            AnswerSQL = "SELECT VCI.Title FROM ValueCaptureInitiatives VCI WHERE VCI.ValueCaptureType = 'One Time Cost'",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "ey-guidance",
                        ...
                        {
                            ID = 317,
                            AnswerSQL = "SELECT VCI.Title FROM ValueCaptureInitiatives VCI WHERE (VCI.ValueCaptureType = 'Cost Reduction' OR  VCI.ValueCaptureType = 'Cost Saving') AND VCI.ProjectTeam = 'IT'",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "ey-guidance",
                        ...
                        {
                            ID = 318,
                            AnswerSQL = "SELECT VCI.Title FROM ValueCaptureInitiatives VCI WHERE VCI.ValueCaptureType = 'One Time Cost' AND VCI.ProjectTeam = 'Supply Chain & Operations'",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "ey-guidance",
