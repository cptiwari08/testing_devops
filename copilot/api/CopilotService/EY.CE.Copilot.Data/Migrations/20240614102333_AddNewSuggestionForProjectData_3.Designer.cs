...
namespace EY.CE.Copilot.Data.Migrations
{
    ...
    [Migration("20240614102333_AddNewSuggestionForProjectData_3")]
    partial class AddNewSuggestionForProjectData_3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EY.CE.Copilot.Data.Models.Suggestion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedBy = "System",
                            Source = "project-data",
                            SuggestionText = "How can I export workplan for just Finance workstream from PMO app?",
                            UpdatedBy = "System",
                            VisibleToAssistant = false
                        },
                        new
                        ...
                        {
                            ID = 258,
                            AnswerSQL = "SELECT   Title DefaultCurrency FROM  TSACurrencies  WHERE CurrencyCode ='{CurrencyCode}'",
                            AppAffinity = "CE4-TSA",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 259,
                            AnswerSQL = "SELECT   CurrencyExchangeRateToUSD  FROM  TSACurrencies  WHERE CurrencyCode ={CurrencyCode}",
                            AppAffinity = "CE4-TSA",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 269,
                            AnswerSQL = "SELECT     [year]                               AS [By Year],     ROUND(SUM(fte_cost_per_month), 2)    AS [TSA FTE Cost for Selected Year],     ROUND(SUM(nonfte_cost_per_month), 2) AS [TSA Non-FTE Cost for Selected Year] FROM     vwTSACostWaterfall WHERE      [year] = '{Year}' GROUP BY     [year]",
                            AppAffinity = "CE4-TSA",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 270,
                            AnswerSQL = "SELECT     Title AS [TSA Stages] FROM     TSAPhases ORDER BY     Ordinal",
                            AppAffinity = "CE4-TSA",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 272,
                            AnswerSQL = "SELECT     Title AS [TSAs that have duration for more than 18 months] FROM     TSAItems WHERE     Duration > 18",
                            AppAffinity = "CE4-TSA",
                            CreatedBy = "System",
                            Source = "project-data",
