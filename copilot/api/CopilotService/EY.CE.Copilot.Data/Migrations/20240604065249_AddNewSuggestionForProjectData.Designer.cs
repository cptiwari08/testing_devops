...
namespace EY.CE.Copilot.Data.Migrations
{
    ...
    [Migration("20240604065249_AddNewSuggestionForProjectData")]
    partial class AddNewSuggestionForProjectData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EY.CE.Copilot.Data.Models.Suggestion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CreatedBy = "System",
                            Source = "project-data",
                            SuggestionText = "List all workplan, raid and interdependencies assigned to Amil Shah",
                            UpdatedBy = "System",
                            VisibleToAssistant = false
                        },
                        new
                        ...
                        {
                            ID = 72,
                            AnswerSQL = "SELECT  	COUNT(ID) AS NewRisksCount FROM  	RisksAndIssues WHERE  	 IssueRiskCategory like $[IssueRiskCategory] 	AND DATEDIFF(day, Created, GETDATE()) <= 5",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        new
                        {
                            ...
                            CreatedBy = "System",
                            Source = "project-data",
                            SuggestionText = "Lsit the number of Systems by Type",
                            UpdatedBy = "System",
                            VisibleToAssistant = true
                        },
                        new
