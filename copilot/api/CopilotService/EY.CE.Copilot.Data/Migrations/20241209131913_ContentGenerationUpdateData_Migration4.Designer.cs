...
namespace EY.CE.Copilot.Data.Migrations
{
    ...
    [Migration("20241209131913_ContentGenerationUpdateData_Migration4")]
    partial class ContentGenerationUpdateData_Migration4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EY.CE.Copilot.Data.Models.ContentGeneratorQuery", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            SQLQuery = "SELECT CASE WHEN COUNT(CASE WHEN WorkPlanTaskStatusId = 1 THEN 1 END) > 0 THEN 'Behind Schedule' WHEN COUNT(CASE WHEN WorkPlanTaskStatusId = 2 THEN 1 END) > 0 THEN 'At Risk' ELSE 'On Track' END AS GeneralStatus FROM WorkPlan WHERE ProjectTeamId = {{ProjectTeam}} AND TaskDueDate < GETDATE() AND TaskDueDate >= DATEADD(DAY, -7, GETDATE())",
