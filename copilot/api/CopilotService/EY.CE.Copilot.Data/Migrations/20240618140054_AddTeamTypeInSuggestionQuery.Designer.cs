...
namespace EY.CE.Copilot.Data.Migrations
{
    ...
    [Migration("20240618140054_AddTeamTypeInSuggestionQuery")]
    partial class AddTeamTypeInSuggestionQuery
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EY.CE.Copilot.Data.Models.Suggestion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 13,
                            AnswerSQL = "SELECT   RiskImpact,  RiskProbability,  COUNT(*) AS RiskCount  FROM  RisksAndIssues RI LEFT JOIN ProjectTeams pt on pt.ID = RI.ProjectTeamId LEFT JOIN TeamTypes TT on TT.ID = pt.TeamTypeId WHERE IssueRiskCategory = 'Risk'  AND ItemStatusId NOT IN (SELECT ID FROM statuses WHERE [Key] IN ('COMPLETED', 'CLOSED'))   AND (RiskImpact IS NOT NULL   OR RiskProbability IS NOT NULL  ) AND TT.[Key] = 'PROJECT_MANAGEMENT' GROUP BY      RiskImpact,     RiskProbability ORDER BY      RiskImpact, RiskProbability",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 20,
                            AnswerSQL = "SELECT W.Title AS WorkPlanItem FROM Workplan W LEFT JOIN ProjectTeams PT ON W.ProjectTeamId = PT.ID LEFT JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID WHERE TT.[Key] = 'PROJECT_MANAGEMENT' AND DATEPART(ww,TaskDueDate) = DATEPART(ww,GETDATE()) + 1",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 26,
                            AnswerSQL = "SELECT RI.Title AS RisksWithNoMitigation FROM RisksandIssues RI LEFT JOIN ProjectTeams PT ON RI.ProjectTeamId = PT.ID LEFT JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID WHERE RiskMitigation IS NULL AND IssueRiskCategory = 'Risk' AND TT.[Key] = 'PROJECT_MANAGEMENT'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 27,
                            AnswerSQL = "SELECT RI.Title AS RisksWithNoMitigation FROM RisksandIssues RI LEFT JOIN ProjectTeams PT ON RI.ProjectTeamId = PT.ID LEFT JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID WHERE RI.ItemOwnerID IS NULL AND IssueRiskCategory = 'Risk' AND TT.[Key] = 'PROJECT_MANAGEMENT'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 28,
                            AnswerSQL = "SELECT W.Title As Milestones FROM Workplan W LEFT JOIN ProjectTeams PT ON W.ProjectTeamId = PT.ID LEFT JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID WHERE WorkplanTaskType = 'Milestone'  AND CAST(StartDate AS DATE) > CAST(GETDATE() AS DATE) AND TT.[Key] = 'PROJECT_MANAGEMENT' AND EXISTS (SELECT 1 FROM [dbo].[WorkPlansToRisksAndIssuesForAssociatedRisksAndIssues] WHERE WorkplanID = W.ID)",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 62,
                            AnswerSQL = "SELECT W.Title AS WorkPlanItem FROM Workplan W LEFT JOIN ProjectTeams PT ON W.ProjectTeamId = PT.ID LEFT JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID WHERE TT.[Key] = 'PROJECT_MANAGEMENT'  AND DATEPART(ww,TaskDueDate) = DATEPART(ww,GETDATE())",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 70,
                            AnswerSQL = "SELECT  COUNT(R.ID) AS NewRisksCount FROM  RisksAndIssues R JOIN ProjectTeams PT ON R.ProjectTeamId = PT.ID JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID WHERE  IssueRiskCategory = 'Risk' AND DATEDIFF(day, R.Created, GETDATE()) <= 5 AND TT.[Key] = 'PROJECT_MANAGEMENT'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 130,
                            AnswerSQL = "SELECT Title Initiatives FROM ValueCaptureInitiatives WHERE ValueCapturePriorityId = 1",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 140,
                            AnswerSQL = "SELECT  	SUM(NonHeadcountCostReductionEst) NonHeadcountCostReduction, 	SUM(HeadcountCostReductionEst) HeadcountCostReduction FROM ValueCaptureTopDownEstimateS",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 141,
                            AnswerSQL = ";WITH CTE AS  ( 	SELECT ProjectTeamID  	FROM ValueCaptureEstimates E 		LEFT JOIN ValueCaptureInitiatives I ON I.ID = E.ValueCaptureInitiativeId 	EXCEPT 	SELECT ProjectTeamID FROM [ValueCaptureTopDownEstimates] )  SELECT PT.Title [ProjectTeam]  FROM CTE LEFT JOIN ProjectTeams PT ON PT.ID = CTE.ProjectTeamID",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 144,
                            AnswerSQL = "SELECT      VC.Title AS ValueCaptureInitiativesReadyForApproval FROM      ValueCaptureInitiatives VC WHERE  	ReadyForApproval = 1",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 146,
                            AnswerSQL = "SELECT TOP 5     Initiatives,Amount FROM( SELECT VI.Title Initiatives ,sum(VE.Amount) Amount FROM      vwUnpivotActuals VE LEFT JOIN      ValueCaptureInitiatives VI ON VI.id = VE.ValueCaptureInitiativeId LEFT JOIN 	ValueCaptureImpactTypes VIT ON VIT.ID = VE.ValueCaptureImpactTypeid GROUP BY      VI.Title,VE.Amount ) A  WHERE A.Amount > 0 ORDER BY  	Amount DESC",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 149,
                            AnswerSQL = "SELECT TOP 1 	PT.Title, SUM(ISNULL(HeadcountCostReductionEst,0)) AS MostHeadcountCostReduction FROM  	ValueCaptureTopDownEstimates LEFT JOIN  	ProjectTeams PT ON PT.ID = ValueCaptureTopDownEstimates.Projectteamid GROUP BY  	PT.Title ORDER BY  	SUM(ISNULL(HeadcountCostReductionEst,0)) DESC",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 152,
                            AnswerSQL = "SELECT  	Title as [Value Capture Initiatives with No Owners] FROM 	ValueCaptureInitiatives as VC WHERE 	ItemOwnerId IS NULL",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 158,
                            AnswerSQL = "SELECT  	VI.Title [Initiatives with Benefit score over 75] FROM 	ValueCaptureInitiatives VI LEFT JOIN  	ProjectTeams PT ON PT.ID = VI.ProjectTeamId WHERE 	CAST(BenefitScore AS INT) > 75 	AND PT.Title IN ('HR')",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 169,
                            AnswerSQL = "SELECT Nodes.Title, a.TotalCount FROM ( SELECT COUNT(N.Title) AS TotalCount, BusinessEntityId FROM Nodes N WHERE NodeTypeId = 3 GROUP BY BusinessEntityId ) a INNER JOIN Nodes ON a.BusinessEntityId = Nodes.ID ",
                            AppAffinity = "CE4-OM",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 174,
                            AnswerSQL = "SELECT d.Title FROM Dispositions d",
                            AppAffinity = "CE4-OM",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 181,
                            AnswerSQL = "SELECT Count(s.ID) AS [# Systems present in this functional OP model] FROM Systems s",
                            AppAffinity = "CE4-OM",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 182,
                            AnswerSQL = "SELECT Count(tpa.ID) AS [# TPAs present in this functional OP model] FROM ThirdPartyAgreements tpa",
                            AppAffinity = "CE4-OM",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 187,
                            AnswerSQL = "SELECT [Object],        OMA.Details,        OMA.FieldImpacted,        OMA.OldValue AS [Old Value],        OMA.NewValue AS [New Value],        [OMA.Title] AS [Activity] FROM OperatingModelActivityLog OMA WHERE OMA.Modified >= DATEADD(hh, -1, GETDATE())",
                            AppAffinity = "CE4-OM",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 188,
                            AnswerSQL = "SELECT [Object],        Details,        OMA.FieldImpacted,        OMA.OldValue AS [Old Value],        OMA.NewValue AS [New Value],        [OMA.Title] AS [Activity] FROM OperatingModelActivityLog OMA WHERE OMA.FieldImpacted = 'Owner'       AND CAST(OMA.Modified AS DATE) = CAST(GETDATE() AS DATE)",
                            AppAffinity = "CE4-OM",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 189,
                            AnswerSQL = "SELECT [Object],        Details,        OMA.FieldImpacted,        OMA.OldValue AS [Old Value],        OMA.NewValue AS [New Value],        [OMA.Title] AS [Activity] FROM OperatingModelActivityLog OMA WHERE OMA.Title = 'Deleted'       AND DATEPART(wk, CAST(OMA.Modified AS DATE)) = DATEPART(wk, CAST(GETDATE() AS DATE))       AND YEAR(OMA.Modified) = YEAR(GETDATE())",
                            AppAffinity = "CE4-OM",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 199,
                            AnswerSQL = "SELECT       N.Title as [List of Processes with No Disposition] FROM Nodes N          WHERE N.NodeTypeId=3 AND N.ID NOT IN   (SELECT DN.NodeId FROM NodesToDispositionsForDispositionNew DN)",
                            AppAffinity = "CE4-OM",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 212,
                            AnswerSQL = "SELECT     N.Title AS [List of Process which doesn''t have ownership] FROM  Nodes   N  JOIN  TransactionStates T  ON T.ID = N.TransactionStateId WHERE     OwnerId IS NULL     AND N.NodeTypeId = 3 -- To select Node Type = Process",
                            AppAffinity = "CE4-OM",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 213,
                            AnswerSQL = "SELECT N.Title AS [List of Processes with more than one Disposition] FROM Nodes N WHERE N.NodeTypeId = 3       AND N.ID IN (                       SELECT NodeID                       FROM                       (                           SELECT NodeId,                                  COUNT(DispositionID) AS [Disposition Count]                           FROM NodesToDispositionsForDispositionNew                           GROUP BY NodeId                           HAVING COUNT(DispositionID) > 1                       ) a                   ) ",
                            AppAffinity = "CE4-OM",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 219,
                            AnswerSQL = "SELECT     Title AS [Systems not tagged in any process] FROM     Systems WHERE     ID NOT IN (                   SELECT DISTINCT                       SystemsId                   FROM                       Nodes                               N                       LEFT JOIN                           NodesToSystemsForEnablerSystems NSS                               ON N.ID = NSS.NodesId  					  LEFT JOIN TransactionStates T ON T.ID = N.TransactionStateId                    WHERE T.Title= 'Day 1' AND                        N.NodeTypeId = 3               )",
                            AppAffinity = "CE4-OM",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 239,
                            AnswerSQL = "SELECT     Title AS [Systems being used by Project Team and Process Group] FROM     Systems WHERE  ID IN (                   SELECT DISTINCT                       SystemsId                   FROM                       Nodes N                       LEFT JOIN NodesToSystemsForEnablerSystems NSS                        ON N.ID = NSS.NodesId  					  LEFT JOIN  NodesToProjectTeamsForProjectTeam NP 					  ON N.ID = NP.NodesId  					  LEFT JOIN NodeTypes NT ON NT.ID = N.NodeTypeId                    WHERE  NT.Title IN ('ProcessGroup')               )	",
                            AppAffinity = "CE4-OM",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 251,
                            AnswerSQL = "SELECT    tb.Title as [Billing Period Name],    tb.DeadlineDate as [Contribution Deadlines]  FROM    TSABillingPeriods tb",
                            AppAffinity = "CE4-TSA",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 252,
                            AnswerSQL = " SELECT    tp.Title AS [TSA Phases]  FROM TSAPhases tp",
                            AppAffinity = "CE4-TSA",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 256,
                            AnswerSQL = "SELECT   tsa.Title DefaultCurrency FROM  TSACurrencies tsa WHERE tsa.CurrencyCode ='{CurrencyCode}'",
                            AppAffinity = "CE4-TSA",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 257,
                            AnswerSQL = "SELECT   tsa.CurrencyExchangeRateToUSD  FROM  TSACurrencies tsa WHERE tsa.CurrencyCode ={CurrencyCode}",
                            AppAffinity = "CE4-TSA",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 261,
                            AnswerSQL = "SELECT     tsa.Title        AS [Billing Period Name],     tsa.DeadlineDate AS [Contribution Deadlines] FROM     TSABillingPeriods tsa",
                            AppAffinity = "CE4-TSA",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 267,
                            AnswerSQL = "SELECT     [tcwf.year]                               AS [By Year],     ROUND(SUM(tcwf.fte_cost_per_month), 2)    AS [TSA FTE Cost for Selected Year],     ROUND(SUM(tcwf.nonfte_cost_per_month), 2) AS [TSA Non-FTE Cost for Selected Year] FROM     vwTSACostWaterfall tcwf WHERE      [tcwf.year] = '{Year}' GROUP BY     [tcwf.year]",
                            AppAffinity = "CE4-TSA",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 268,
                            AnswerSQL = "SELECT     tp.Title AS [TSA Stages] FROM     TSAPhases tp ORDER BY     Ordinal",
                            AppAffinity = "CE4-TSA",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 270,
                            AnswerSQL = "SELECT     ti.Title AS [TSAs that have duration for more than 18 months] FROM     TSAItems ti WHERE     ti.Duration > 18",
                            AppAffinity = "CE4-TSA",
                            CreatedBy = "System",
                            Source = "project-data",
