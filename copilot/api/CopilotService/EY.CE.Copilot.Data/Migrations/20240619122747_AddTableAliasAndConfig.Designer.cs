...
namespace EY.CE.Copilot.Data.Migrations
{
    ...
    [Migration("20240619122747_AddTableAliasAndConfig")]
    partial class AddTableAliasAndConfig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EY.CE.Copilot.Data.Models.Suggestion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 16,
                            AnswerSQL = "SELECT W.Title AS WorkPlanItem FROM Workplan W LEFT JOIN UserProfiles UP ON W.TaskOwnerID = UP.ID LEFT JOIN ProjectTeams PT ON W.ProjectTeamId = PT.ID LEFT JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID WHERE UP.Title = '{Username}' AND TT.[Key] = 'PROJECT_MANAGEMENT'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 79,
                            AnswerSQL = "SELECT 'Total Top Down Target' AS KPI, FORMAT((SUM(VCTDE.HeadcountCostReductionEst)+SUM(VCTDE.NonHeadcountCostReductionEst)+SUM(VCTDE.RevenueGrowthEstimate))/1000000,'N2') AS 'Value (Million)' FROM ValueCaptureTopDownEstimates VCTDE",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 93,
                            AnswerSQL = "SELECT SUM(VCTDE.NonHeadcountCostReductionEst) + SUM(VCTDE.RevenueGrowthEstimate) + SUM(VCTDE.HeadcountCostReductionEst) 'Total Top Down Target Value' FROM ValueCaptureTopDownEstimates VCTDE",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 94,
                            AnswerSQL = "SELECT SUM(VCTDE.RevenueGrowthEstimate) RevenueGrowth,SUM(VCTDE.TotalCostReduction) CostReduction FROM ValueCaptureTopDownEstimates VCTDE",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 95,
                            AnswerSQL = "SELECT COUNT(VCI.ID) FROM ValueCaptureInitiatives VCI WHERE VCI.IsItemActive = 1",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 109,
                            AnswerSQL = "SELECT PT.Title,SUM(ISNULL(VCTDE.NonHeadcountCostReductionEst,0)) + SUM(ISNULL(VCTDE.RevenueGrowthEstimate,0)) + SUM(ISNULL(VCTDE.HeadcountCostReductionEst,0)) AS TotalTopDownTarget FROM ValueCaptureTopDownEstimates VCTDE LEFT JOIN ProjectTeams PT ON PT.ID = VCTDE.ProjectTeamId GROUP BY PT.Title",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 115,
                            AnswerSQL = "SELECT SUM(ISNULL(VCTDE.HeadcountCostReductionEst,0)) AS HeadcountCostReduction FROM ValueCaptureTopDownEstimates VCTDE",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                            SuggestionText = "What is the Total Headcount Cost Reduction Target?",
                        ...
                        {
                            ID = 116,
                            AnswerSQL = "SELECT SUM(ISNULL(VCTDE.NonHeadcountCostReductionEst,0)) AS NonHeadcountCostReduction FROM ValueCaptureTopDownEstimates VCTDE",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 117,
                            AnswerSQL = "SELECT SUM(ISNULL(VCTDE.RevenueGrowthEstimate,0)) AS RevenueGrowth FROM ValueCaptureTopDownEstimates VCTDE",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 118,
                            AnswerSQL = "SELECT SUM(ISNULL(VCTDE.CostToAchieveEstimate,0)) AS CostToAchive FROM ValueCaptureTopDownEstimates VCTDE",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 126,
                            AnswerSQL = "SELECT CONCAT('Tracking Period of the Program is from ', CAST(MIN(VCTM.StartDt) AS DATE), ' to ', CAST(MAX(VCTM.EndDt) AS DATE)) FROM ValueCaptureTransactionMonths VCTM WHERE VCTM.IsItemActive = 1",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 130,
                            AnswerSQL = "SELECT VCI.Title Initiatives FROM ValueCaptureInitiatives VCI WHERE VCI.ValueCapturePriorityId = 1",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                            SuggestionText = "List all initiatives that requires attention.",
                            UpdatedBy = "System",
                            VisibleToAssistant = true
                        },
                        new
                        ...
                        {
                            ID = 140,
                            AnswerSQL = "SELECT SUM(VCTDE.NonHeadcountCostReductionEst) NonHeadcountCostReduction, SUM(VCTDE.HeadcountCostReductionEst) HeadcountCostReduction FROM ValueCaptureTopDownEstimates VCTDE",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 149,
                            AnswerSQL = "SELECT TOP 1 PT.Title, SUM(ISNULL(VCTDE.HeadcountCostReductionEst,0)) AS MostHeadcountCostReduction FROM ValueCaptureTopDownEstimates VCTDE LEFT JOIN ProjectTeams PT ON PT.ID = VCTDE.ProjectTeamId GROUP BY PT.Title ORDER BY SUM(ISNULL(VCTDE.HeadcountCostReductionEst,0)) DESC",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 160,
                            AnswerSQL = "SELECT  	VI.Title [top 5 initiatives with best benefit score] FROM  	ValueCaptureInitiatives VI LEFT JOIN 	ValueCaptureImpactTypes VIT ON VIT.ID = VI.ValueCaptureImpactTypeId LEFT JOIN  	ValueCaptureImpacts VIM ON VIM.ID = VI.ValueCaptureImpactid WHERE  	VIM.[Key] in ('High') 	AND VIT.PositiveOrNegativeValues IN ('Positive')",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 163,
                            AnswerSQL = "SELECT  	PT.Title ProjectTeam,SUM(ISNULL(NonHeadcountCostReductionEst,0)) NonHeadcountCostReductionTarget FROM  	ValueCaptureTopDownEstimates LEFT JOIN  	ProjectTeams PT ON PT.ID = ValueCaptureTopDownEstimates.Projectteamid GROUP BY  	PT.Title",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 273,
                            AnswerSQL = "SELECT TSA.Title AS [TSAs with Open Risks] FROM TSAItems TSA     LEFT JOIN RisksAndIssues RI         ON TSA.ID = RI.TSAItemId     LEFT JOIN Statuses S         ON RI.ProgressId = S.ID WHERE S.[Key] NOT IN ( 'COMPLETED', 'CLOSED' )",
                            AppAffinity = "CE4-TSA",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 310,
                            AnswerSQL = "SELECT DISTINCT WP._TemplateFile FROM WorkPlan WP",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "ey-guidance",
                        ...
                        {
                            ID = 319,
                            AnswerSQL = "SELECT VCI.Title FROM ValueCaptureInitiatives VCI WHERE VCI.ValueCaptureType = 'Cost Savings'",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "ey-guidance",
                        ...
                        {
                            ID = 320,
                            AnswerSQL = "SELECT VCI.Title FROM ValueCaptureInitiatives VCI WHERE VCI.ValueCaptureType = 'Revenue Growth'",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "ey-guidance",
                        ...
                        {
                            ID = 321,
                            AnswerSQL = "SELECT VCI.Title FROM ValueCaptureInitiatives VCI WHERE VCI.ValueCaptureType = 'one-time'",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "ey-guidance",
                        ...
                        {
                            ID = 322,
                            AnswerSQL = "SELECT VCI.Title FROM ValueCaptureInitiatives VCI WHERE VCI.ValueCaptureType = 'Cost Savings' AND VCI.ProjectTeam = 'IT'",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "ey-guidance",
                        ...
                        {
                            ID = 323,
                            AnswerSQL = "SELECT VCI.Title FROM ValueCaptureInitiatives VCI WHERE VCI.ValueCaptureType = 'one-time' AND VCI.ProjectTeam = 'Supply Chain'",
                            AppAffinity = "CE4-VC",
                            CreatedBy = "System",
                            Source = "ey-guidance",
                        ...
                        {
                            ID = 327,
                            AnswerSQL = "SELECT DISTINCT N._TemplateFile FROM Nodes N",
                            AppAffinity = "CE4-OM",
                            CreatedBy = "System",
                            Source = "ey-guidance",
                        ...
                        {
                            ID = 332,
                            AnswerSQL = "SELECT TSA.Title FROM TSAItems TSA",
                            AppAffinity = "CE4-TSA",
                            CreatedBy = "System",
                            Source = "ey-guidance",
                        ...
                        {
                            ID = 333,
                            AnswerSQL = "SELECT TSA.Title, TSA.ServiceInScopeDescription, TSA.[Function], TSA.SubFunction FROM TSAItems TSA",
                            AppAffinity = "CE4-TSA",
                            CreatedBy = "System",
                            Source = "ey-guidance",
