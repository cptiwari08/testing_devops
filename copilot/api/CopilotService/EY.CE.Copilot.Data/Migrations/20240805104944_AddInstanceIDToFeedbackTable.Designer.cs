...
namespace EY.CE.Copilot.Data.Migrations
{
    ...
    [Migration("20240805104944_AddInstanceIDToFeedbackTable")]
    partial class AddInstanceIDToFeedbackTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EY.CE.Copilot.Data.Models.Suggestion", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 4,
                            AnswerSQL = "SELECT wp.Title  from WorkPlan wp   LEFT JOIN Statuses s on wp.WorkPlanTaskStatusId = s.ID  left join ProjectTeams pt on pt.ID = wp.ProjectTeamId LEFT JOIN TeamTypes TT on TT.ID = pt.TeamTypeId where s.[Key] = 'BEHIND_SCHEDULE'  AND wp.WorkPlanTaskType = 'Milestone' and TT.[Key] = 'PROJECT_MANAGEMENT'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 5,
                            AnswerSQL = "SELECT RI.Title  from RisksAndIssues RI   LEFT JOIN Statuses s on RI.ItemStatusId = s.ID   LEFT JOIN ProjectTeams pt on pt.ID = RI.ProjectTeamId LEFT JOIN TeamTypes TT on TT.ID = pt.TeamTypeId where s.[Key] = 'BEHIND_SCHEDULE'  AND RI.IssueRiskCategory = 'Risk' and TT.[Key] = 'PROJECT_MANAGEMENT'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 16,
                            AnswerSQL = "SELECT W.Title, UP.Title as UserName AS WorkPlanItem FROM Workplan W LEFT JOIN UserProfiles UP ON W.TaskOwnerID = UP.ID LEFT JOIN ProjectTeams PT ON W.ProjectTeamId = PT.ID LEFT JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID WHERE UP. Title = ( SELECT TOP 1 Title  FROM UserProfiles WHERE FREETEXT(Title, '{Username}') AND TT.[Key] = 'PROJECT_MANAGEMENT'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 17,
                            AnswerSQL = "SELECT TOP 1 CAST(RP.PeriodEndDate AS DATE) AS WeeklyStatusDueDate  FROM ReportingPeriods RP WHERE CAST(GETDATE() AS DATE) BETWEEN CAST(RP.PeriodStartDate AS DATE) AND CAST(RP.PeriodEndDate AS DATE) ORDER BY RP.Modified DESC",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 19,
                            AnswerSQL = "SELECT WP.Title FROM Workplan WP JOIN ProjectTeams PT ON WP.ProjectTeamId = PT.ID JOIN Statuses S ON WP.WorkPlanTaskStatusId = S.ID JOIN TeamTypes TT ON PT.TeamTypeID = TT.ID WHERE S.[Key] = 'BEHIND_SCHEDULE' AND TT.[Key] = 'PROJECT_MANAGEMENT' AND PT.Title = {ProjectTeam}",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 20,
                            AnswerSQL = "SELECT W.Title AS WorkPlanItem FROM Workplan W LEFT JOIN ProjectTeams PT ON W.ProjectTeamId = PT.ID LEFT JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID WHERE TT.[Key] = 'PROJECT_MANAGEMENT' AND DATEPART(ww,W.TaskDueDate) = DATEPART(ww,GETDATE()) + 1",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 24,
                            AnswerSQL = "SELECT I.Title FROM Interdependencies I WHERE CAST(I.ItemDueDate AS DATE) < CAST(GETDATE() AS DATE)",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 26,
                            AnswerSQL = "SELECT RI.Title AS RisksWithNoMitigation FROM RisksandIssues RI LEFT JOIN ProjectTeams PT ON RI.ProjectTeamId = PT.ID LEFT JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID WHERE RI.RiskMitigation IS NULL AND RI.IssueRiskCategory = 'Risk' AND TT.[Key] = 'PROJECT_MANAGEMENT'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 27,
                            AnswerSQL = "SELECT RI.Title AS RisksWithNoMitigation FROM RisksandIssues RI LEFT JOIN ProjectTeams PT ON RI.ProjectTeamId = PT.ID LEFT JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID WHERE RI.ItemOwnerID IS NULL AND RI.IssueRiskCategory = 'Risk' AND TT.[Key] = 'PROJECT_MANAGEMENT'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 28,
                            AnswerSQL = "SELECT W.Title As Milestones FROM Workplan W LEFT JOIN ProjectTeams PT ON W.ProjectTeamId = PT.ID LEFT JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID WHERE W.WorkplanTaskType = 'Milestone'  AND CAST(W.StartDate AS DATE) > CAST(GETDATE() AS DATE) AND TT.[Key] = 'PROJECT_MANAGEMENT' AND EXISTS (SELECT 1 FROM WorkPlansToRisksAndIssuesForAssociatedRisksAndIssues WRIARI WHERE WRIARI.WorkPlanId = W.ID)",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 31,
                            AnswerSQL = "SELECT Parent.Title AS ParentTeam FROM ProjectTeams Parent JOIN ProjectTeams Child ON Child.ParentProjectTeamId = Parent.ID JOIN TeamTypes TT ON Parent.TeamTypeId = TT.ID WHERE TT.[Key] = 'PROJECT_MANAGEMENT' AND Child.Title = {ProjectTeam}",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 36,
                            AnswerSQL = "SELECT  WP.UniqueItemIdentifier ,WP.Title FROM WORKPLAN WP JOIN ProjectTeams PT ON WP.ProjectTeamId = PT.ID JOIN Statuses S ON WP.WorkPlanTaskStatusId = S.ID JOIN TeamTypes TT ON PT.TeamTypeID = TT.ID WHERE  TaskOwnerId IS NULL AND WorkPlanTaskType = 'Task' AND TT.[Key] = 'PROJECT_MANAGEMENT'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 47,
                            AnswerSQL = "SELECT I.UniqueItemIdentifier, I.Title as OpenInterdependencies, S.Title as Status FROM Interdependencies I LEFT JOIN InterdependencyStatuses S ON I.InterdependencyStatusId = S.ID  WHERE S.[KEY] NOT IN ('COMPLETED', 'CLOSED', 'CANCELLED', 'DELETED', 'REJECTED',  'ON_HOLD')",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 48,
                            AnswerSQL = "SELECT    W.UniqueItemIdentifier,    W.TITLE as CriticalTasks  FROM    Workplan W      JOIN ProjectTeams PT On W.WorkstreamId = PT.ID  JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID WHERE    W.IsCritical = 1   AND TT.[Key] = 'PROJECT_MANAGEMENT'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 53,
                            AnswerSQL = "SELECT  W.UniqueItemIdentifier,W.Title TasksWithoutOwner FROM  WorkPlan W JOIN ProjectTeams PT On W.WorkstreamId = PT.ID  JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID WHERE  W.TaskOwnerId IS NULL AND TT.[Key] = 'PROJECT_MANAGEMENT'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 54,
                            AnswerSQL = "SELECT  RI.UniqueItemIdentifier,RI.Title ItemsWithoutOwner, IssueRiskCategory AS Category FROM  RisksAndIssues RI LEFT JOIN ProjectTeams PT ON RI.ProjectTeamId = PT.ID LEFT JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID  WHERE  RI.ItemOwnerId IS NULL AND TT.[Key] = 'PROJECT_MANAGEMENT' UNION  SELECT  A.UniqueItemIdentifier,A.Title  ItemsWithoutOwner, 'Actions' AS Category FROM  Actions A LEFT JOIN ProjectTeams PT ON A.ProjectTeamId = PT.ID LEFT JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID WHERE  A.ItemOwnerId IS NULL AND TT.[Key] = 'PROJECT_MANAGEMENT'  UNION  SELECT  D.UniqueItemIdentifier,D.Title  ItemsWithoutOwner, 'Decisions' AS Category FROM  Decisions D LEFT JOIN ProjectTeams PT ON D.ProjectTeamId = PT.ID LEFT JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID WHERE  D.ItemOwnerId IS NULL AND TT.[Key] = 'PROJECT_MANAGEMENT'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 57,
                            AnswerSQL = "SELECT RI.Title RisksAndIssues, IssueRiskCategory  FROM RisksAndIssues RI  LEFT JOIN Statuses S ON S.ID = RI.ItemStatusId  LEFT JOIN ProjectTeams PT ON RI.ProjectTeamID = PT.ID  LEFT JOIN TeamTypes TT on TT.ID  = PT.TeamTypeId WHERE IsCritical IN (1) AND S.[Key] NOT IN ('CLOSED') AND TT.[Key]='PROJECT_MANAGEMENT'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 62,
                            AnswerSQL = "SELECT W.Title AS WorkPlanItem FROM Workplan W LEFT JOIN ProjectTeams PT ON W.ProjectTeamId = PT.ID LEFT JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID WHERE TT.[Key] = 'PROJECT_MANAGEMENT'  AND DATEPART(ww,W.TaskDueDate) = DATEPART(ww,GETDATE())",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 68,
                            AnswerSQL = "SELECT DISTINCT PT.Title as ProjectTeams_With_Items_At_Risk  FROM ProjectTeams PT    JOIN Workplan W ON W.ProjectTeamID = PT.ID    JOIN Statuses S ON S.ID = W.WorkplanTaskStatusID    JOIN TeamTypes TT ON PT.TeamTypeId = TT.ID WHERE    S.[Key] = 'AT_RISK'   AND TT.[Key] = 'PROJECT_MANAGEMENT'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
                        ...
                        {
                            ID = 74,
                            AnswerSQL = "SELECT     RI.TITLE AS [Risk items that does not have Risk Mitigation plan] FROM     RisksAndIssues RI  LEFT JOIN ProjectTeams PT ON RI.ProjectTeamID = PT.ID  LEFT JOIN TeamTypes TT on TT.ID  = PT.TeamTypeId WHERE     RI.IssueRiskCategory = 'Risk'     AND RI.RiskMitigation IS  NULL AND TT.[Key]='PROJECT_MANAGEMENT'",
                            AppAffinity = "CE4-PMO",
                            CreatedBy = "System",
                            Source = "project-data",
