...
{
    /// <inheritdoc />
    public partial class SuggestionPMOInterdependencyUpdate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "SELECT      ReceiverTeam.Title AS ReceiverTeamName,     COUNT(1) AS InterdependencyCount FROM      Interdependencies AS I INNER JOIN      ProjectTeams AS ReceiverTeam ON I.ReceiverProjectTeamId = ReceiverTeam.ID GROUP BY      ReceiverTeam.Title", "How many interdependencies does each receiver team have?" });
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "SELECT      ReceiverTeam.Title AS ReceiverTeamTitle,     COUNT(1) AS OverdueDependencyCount FROM      Interdependencies I INNER JOIN      ProjectTeams ReceiverTeam ON I.ReceiverProjectTeamId = ReceiverTeam.ID LEFT JOIN      InterdependencyStatuses S ON I.InterdependencyStatusId = S.ID WHERE      I.ItemDueDate < GETDATE()     AND (S.[Key] IS NULL OR S.[Key] NOT IN ('COMPLETED', 'CLOSED')) GROUP BY      ReceiverTeam.Title ORDER BY      OverdueDependencyCount DESC", "CE4-PMO", "Which receiver project team has the most overdue interdependencies?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 15,
                columns: new[] { "AnswerSQL", "AppAffinity", "SuggestionText" },
                values: new object[] { "SELECT      ProviderTeam.Title AS ProviderTeamame,     COUNT(1) AS InterdependencyCount FROM      Interdependencies AS I INNER JOIN      ProjectTeams AS ProviderTeam ON I.ProviderProjectTeamId = ProviderTeam.ID GROUP BY      ProviderTeam.Title", "CE4-PMO", "How many interdependencies does each provider team have " });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 111, null, "PROJECT_LEVEL", null, "System", "internet", "What are the best practices to run weekly status meetings?", null, "System" },
                    { 112, null, "PROJECT_LEVEL", null, "System", "internet", "What are the best practices to build workplan, and track dependencies?", null, "System" }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 3,
                columns: new[] { "AnswerSQL", "SuggestionText" },
                values: new object[] { "SELECT      ReceiverTeam.Title AS ReceiverTeamName,     COUNT(*) AS InterdependencyCount FROM      Interdependencies AS I INNER JOIN      ProjectTeams AS ReceiverTeam ON I.ReceiverProjectTeamId = ReceiverTeam.ID GROUP BY      ReceiverTeam.Title", "How many interdependencies does each team have?" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 6,
                column: "AnswerSQL",
                value: "SELECT I.Title  from Interdependencies I  LEFT JOIN Statuses s on I.InterdependencyStatusId = s.ID  where s.[Key] = 'BEHIND_SCHEDULE'");
