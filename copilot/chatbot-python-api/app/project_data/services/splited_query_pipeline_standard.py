...
from app.project_data.functions.question_rewritting_team_type import (
    question_rewritting_team_type,
)
from app.project_data.functions.send_teamtype_info import send_teamtype
from app.project_data.functions.send_teamtype_output import send_teamtype_output
...
class SplitedPipelineStandard:
    def __init__(self, context: QueryPipelineContext):
        ...
        self.question_rewritting_team_type_ = (
            lambda nodes: question_rewritting_team_type(
                nodes, context
            )
        )
        ...
        self.send_teamtype_ = lambda: send_teamtype(context)
        self.send_teamtype_output_ = lambda team_name: send_teamtype_output(
            team_name, context
        )
    ...
    def build_second_dict(self, input_dict: dict):
        map_new_names = {
            ...
            "question_rewritting_team_type": "user_question",
    ...
    def build_final_dict(self, input_dict: dict):
        map_new_names = {
            "send_teamtype_output": "team_name",
    ...
    async def execute_first_step(self, input_data: dict):
        ...
        modules_first_pipeline = {
            ...
            "question_rewritting_team_type": FnComponent(
                fn=self.question_rewritting_team_type_
            ),
