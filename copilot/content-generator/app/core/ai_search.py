...
class AISearch:
    ...
    async def perform_full_text_query(self, search_text: str, filters: str, top: int = -1,
        ...
        if top < 0:
            async with ai_search_client as client:
                raw_search_results = await client.search(
                ...
                search_results = []
                async for page in raw_search_results.by_page():
